...
// Multi-list cases
extern "C" __global__ AICORE void TMRGSORT_f32_2list_b64_basic(
...
extern "C" __global__ AICORE void TMRGSORT_f32_2list_exhausted(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* dst);
...
extern "C" __global__ AICORE void TMRGSORT_f32_3list_b64_basic(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* src2, __gm__ float* dst);

void LaunchTMRGSORT_f32_3list_b64_basic(float* src0, float* src1, float* src2, float* dst, void* stream)
{
    TMRGSORT_f32_3list_b64_basic<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)src2, (__gm__ float*)dst);
}

extern "C" __global__ AICORE void TMRGSORT_f32_4list_b32_basic(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* src2, __gm__ float* src3, __gm__ float* dst);

void LaunchTMRGSORT_f32_4list_b32_basic(float* src0, float* src1, float* src2, float* src3, float* dst, void* stream)
{
    TMRGSORT_f32_4list_b32_basic<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)src2, (__gm__ float*)src3, (__gm__ float*)dst);
}

// 4-list case: f16_4list_b64_basic
extern "C" __global__ AICORE void TMRGSORT_f16_4list_b64_basic(
    __gm__ half* src0, __gm__ half* src1, __gm__ half* src2, __gm__ half* src3, __gm__ half* dst);

void LaunchTMRGSORT_f16_4list_b64_basic(
    uint16_t* src0, uint16_t* src1, uint16_t* src2, uint16_t* src3, uint16_t* dst, void* stream)
{
    TMRGSORT_f16_4list_b64_basic<<<1, nullptr, stream>>>(
        (__gm__ half*)src0, (__gm__ half*)src1, (__gm__ half*)src2, (__gm__ half*)src3, (__gm__ half*)dst);
}

// 4-list case: f16_4list_basic (pto-isa case_multi2)
extern "C" __global__ AICORE void TMRGSORT_f16_4list_basic(
    __gm__ half* src0, __gm__ half* src1, __gm__ half* src2, __gm__ half* src3, __gm__ half* dst);

void LaunchTMRGSORT_f16_4list_basic(
    uint16_t* src0, uint16_t* src1, uint16_t* src2, uint16_t* src3, uint16_t* dst, void* stream)
{
    TMRGSORT_f16_4list_basic<<<1, nullptr, stream>>>(
        (__gm__ half*)src0, (__gm__ half*)src1, (__gm__ half*)src2, (__gm__ half*)src3, (__gm__ half*)dst);
}

// 3-list non-uniform: f32_3list_non_uniform
extern "C" __global__ AICORE void TMRGSORT_f32_3list_non_uniform(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* src2, __gm__ float* dst);

void LaunchTMRGSORT_f32_3list_non_uniform(float* src0, float* src1, float* src2, float* dst, void* stream)
{
    TMRGSORT_f32_3list_non_uniform<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)src2, (__gm__ float*)dst);
}

// 3-list f16 exhausted: f16_3list_exhausted
extern "C" __global__ AICORE void TMRGSORT_f16_3list_exhausted(
    __gm__ half* src0, __gm__ half* src1, __gm__ half* src2, __gm__ half* dst);

void LaunchTMRGSORT_f16_3list_exhausted(uint16_t* src0, uint16_t* src1, uint16_t* src2, uint16_t* dst, void* stream)
{
    TMRGSORT_f16_3list_exhausted<<<1, nullptr, stream>>>(
        (__gm__ half*)src0, (__gm__ half*)src1, (__gm__ half*)src2, (__gm__ half*)dst);
}

// 4-list non-uniform: f32_4list_non_uniform
extern "C" __global__ AICORE void TMRGSORT_f32_4list_non_uniform(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* src2, __gm__ float* src3, __gm__ float* dst);

void LaunchTMRGSORT_f32_4list_non_uniform(float* src0, float* src1, float* src2, float* src3, float* dst, void* stream)
{
    TMRGSORT_f32_4list_non_uniform<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)src2, (__gm__ float*)src3, (__gm__ float*)dst);
}
