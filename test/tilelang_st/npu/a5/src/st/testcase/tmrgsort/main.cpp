...
void LaunchTMRGSORT_f16_4list_b64_basic(
    uint16_t* src0, uint16_t* src1, uint16_t* src2, uint16_t* src3, uint16_t* dst, void* stream);
void LaunchTMRGSORT_f16_4list_basic(
    uint16_t* src0, uint16_t* src1, uint16_t* src2, uint16_t* src3, uint16_t* dst, void* stream);
...
static const TestCase kCases[] = {
    ...
    {"f32_single_1x256_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_single_1x256_b64), nullptr, nullptr,
     nullptr, 1, 256, 0, 0, 0, 0, 1, 256, sizeof(float), 8, 2},
    {"f32_single_1x320_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_single_1x320_b64), nullptr, nullptr,
     nullptr, 1, 320, 0, 0, 0, 0, 1, 320, sizeof(float), 8, 2},
    {"f32_single_1x512_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_single_1x512_b64), nullptr, nullptr,
     nullptr, 1, 512, 0, 0, 0, 0, 1, 512, sizeof(float), 8, 2},
    {"f32_single_1x640_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_single_1x640_b64), nullptr, nullptr,
     nullptr, 1, 640, 0, 0, 0, 0, 1, 640, sizeof(float), 8, 2},
    {"f16_single_1x256_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_single_1x256_b64), nullptr, nullptr,
     nullptr, 1, 512, 0, 0, 0, 0, 1, 512, sizeof(uint16_t), 8, 4},
    {"f16_single_1x320_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_single_1x320_b64), nullptr, nullptr,
     nullptr, 1, 640, 0, 0, 0, 0, 1, 640, sizeof(uint16_t), 8, 4},
    {"f16_single_1x512_b64", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_single_1x512_b64), nullptr, nullptr,
     nullptr, 1, 1024, 0, 0, 0, 0, 1, 1024, sizeof(uint16_t), 8, 4},
    {"f16_single_1x1024_b256", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_single_1x1024_b256), nullptr, nullptr,
     nullptr, 1, 2048, 0, 0, 0, 0, 1, 2048, sizeof(uint16_t), 8, 4},

    // Multi-list cases (Format2)
    {"f32_2list_b64_basic", 2, nullptr, reinterpret_cast<LaunchFn2>(LaunchTMRGSORT_f32_2list_b64_basic), nullptr,
     nullptr, 1, 0, 256, 256, 0, 0, 1, 256, sizeof(float), 8, 2},
    {"f16_2list_b64_basic", 2, nullptr, reinterpret_cast<LaunchFn2>(LaunchTMRGSORT_f16_2list_b64_basic), nullptr,
     nullptr, 1, 0, 256, 256, 0, 0, 1, 256, sizeof(uint16_t), 8, 4},

    // Exhausted cases (aligned with pto-isa case_exhausted1: kGCols_=64)
    {"f32_2list_exhausted", 2, nullptr, reinterpret_cast<LaunchFn2>(LaunchTMRGSORT_f32_2list_exhausted), nullptr,
     nullptr, 1, 0, 64, 64, 0, 0, 1, 128, sizeof(float), 8, 2},

    // 3-list and 4-list cases
    {"f32_3list_b64_basic", 3, nullptr, nullptr, reinterpret_cast<LaunchFn3>(LaunchTMRGSORT_f32_3list_b64_basic),
     nullptr, 1, 0, 128, 128, 128, 0, 1, 256, sizeof(float), 8, 2},
    {"f32_3list_non_uniform", 3, nullptr, nullptr, reinterpret_cast<LaunchFn3>(LaunchTMRGSORT_f32_3list_non_uniform),
     nullptr, 1, 0, 128, 128, 64, 0, 1, 128, sizeof(float), 8, 2},
    {"f16_3list_exhausted", 3, nullptr, nullptr, reinterpret_cast<LaunchFn3>(LaunchTMRGSORT_f16_3list_exhausted),
     nullptr, 1, 0, 512, 512, 512, 0, 1, 1536, sizeof(uint16_t), 8, 4},
    {"f32_4list_b32_basic", 4, nullptr, nullptr, nullptr,
     reinterpret_cast<LaunchFn4>(LaunchTMRGSORT_f32_4list_b32_basic), 1, 0, 128, 128, 128, 128, 1, 512, sizeof(float),
     8, 2},
    {"f32_4list_non_uniform", 4, nullptr, nullptr, nullptr,
     reinterpret_cast<LaunchFn4>(LaunchTMRGSORT_f32_4list_non_uniform), 1, 0, 128, 128, 128, 64, 1, 448, sizeof(float),
     8, 2},
    {"f16_4list_b64_basic", 4, nullptr, nullptr, nullptr,
     reinterpret_cast<LaunchFn4>(LaunchTMRGSORT_f16_4list_b64_basic), 1, 0, 256, 256, 256, 256, 1, 1024,
     sizeof(uint16_t), 8, 4},
    {"f16_4list_basic", 4, nullptr, nullptr, nullptr, reinterpret_cast<LaunchFn4>(LaunchTMRGSORT_f16_4list_basic), 1, 0,
     256, 256, 256, 256, 1, 1024, sizeof(uint16_t), 8, 4},

    // TopK cases (Format5)
    {"f32_topk_2048_1024", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_topk_2048_1024), nullptr, nullptr, nullptr,
     1, 2048, 0, 0, 0, 0, 1, 1024, sizeof(float), 8, 2},
    {"f32_topk_2048_2048", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_topk_2048_2048), nullptr, nullptr, nullptr,
     1, 2048, 0, 0, 0, 0, 1, 2048, sizeof(float), 8, 2},
    {"f32_topk_1280_512", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f32_topk_1280_512), nullptr, nullptr, nullptr, 1,
     1280, 0, 0, 0, 0, 1, 512, sizeof(float), 8, 2},
    {"f16_topk_2048_1024", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_topk_2048_1024), nullptr, nullptr, nullptr,
     1, 2048, 0, 0, 0, 0, 1, 1024, sizeof(uint16_t), 8, 4},
    {"f16_topk_2048_2048", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_topk_2048_2048), nullptr, nullptr, nullptr,
     1, 2048, 0, 0, 0, 0, 1, 2048, sizeof(uint16_t), 8, 4},
    {"f16_topk_1280_512", 1, reinterpret_cast<LaunchFn>(LaunchTMRGSORT_f16_topk_1280_512), nullptr, nullptr, nullptr, 1,
     1280, 0, 0, 0, 0, 1, 512, sizeof(uint16_t), 8, 4},
};
...
static int RunCase(const TestCase& tc, aclrtStream stream)
{
    ...
    // Multi-list case (Format2)
        ...
        std::printf(
            "[INFO] === case: %s (src0=%zux%zu, src1=%zux%zu, dst=%zux%zu) ===\n", tc.name, tc.srcRows, tc.srcCols0,
            tc.srcRows, tc.srcCols1, tc.dstRows, tc.dstCols);
    ...
    // 3-list case (Format3)
        ...
        std::printf(
            "[INFO] === case: %s (src0=%zux%zu, src1=%zux%zu, src2=%zux%zu, dst=%zux%zu) ===\n", tc.name, tc.srcRows,
            tc.srcCols0, tc.srcRows, tc.srcCols1, tc.srcRows, tc.srcCols2, tc.dstRows, tc.dstCols);
    ...
    // 4-list case (Format4)
        ...
        std::printf(
            "[INFO] === case: %s (src0=%zux%zu, src1=%zux%zu, src2=%zux%zu, src3=%zux%zu, dst=%zux%zu) ===\n", tc.name,
            tc.srcRows, tc.srcCols0, tc.srcRows, tc.srcCols1, tc.srcRows, tc.srcCols2, tc.srcRows, tc.srcCols3,
            tc.dstRows, tc.dstCols);

        void *src0Host = nullptr, *src1Host = nullptr, *src2Host = nullptr, *src3Host = nullptr, *dstHost = nullptr;
        void *src0Device = nullptr, *src1Device = nullptr, *src2Device = nullptr, *src3Device = nullptr,
             *dstDevice = nullptr;
