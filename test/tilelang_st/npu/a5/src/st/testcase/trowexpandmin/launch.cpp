...
extern "C" __global__ AICORE void TROWEXPANDMIN_f16_48x64(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);
extern "C" __global__ AICORE void TROWEXPANDMIN_f16_16x128(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);
extern "C" __global__ AICORE void TROWEXPANDMIN_f16_32x64_noeq(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);

void LaunchTROWEXPANDMIN_f16_48x64(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDMIN_f16_48x64<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
void LaunchTROWEXPANDMIN_f16_16x128(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDMIN_f16_16x128<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
void LaunchTROWEXPANDMIN_f16_32x64_noeq(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDMIN_f16_32x64_noeq<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}

// i32 kernels
extern "C" __global__ AICORE void TROWEXPANDMIN_i32_16x32(
...
// i16 kernels
extern "C" __global__ AICORE void TROWEXPANDMIN_i16_16x64(
