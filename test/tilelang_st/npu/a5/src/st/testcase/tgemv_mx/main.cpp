...
void LaunchTGEMV_MX_gemv_mx_fp4_e1m2_1x128x62(
    uint8_t* a, uint8_t* b, uint8_t* scale_a, uint8_t* scale_b, float* c, void* stream);
void LaunchTGEMV_MX_gemv_mx_fp8_e4m3_e5m2_1x256x20(
    uint8_t* a, uint8_t* b, uint8_t* scale_a, uint8_t* scale_b, float* c, void* stream);
void LaunchTGEMV_MX_gemv_mx_bias_fp4_e1m2_1x64x62(
    uint8_t* a, uint8_t* b, uint8_t* scale_a, uint8_t* scale_b, float* bias, float* c, void* stream);
void LaunchTGEMV_MX_gemv_mx_bias_fp4_e1m2_1x2048x64(
    uint8_t* a, uint8_t* b, uint8_t* scale_a, uint8_t* scale_b, float* bias, float* c, void* stream);
...
static const TestCase kCases[] = {
    {"gemv_mx_fp4_e1m2_1x128x62", false, true, 1, 128, 62, 16, 64, 64, 128, LaunchTGEMV_MX_gemv_mx_fp4_e1m2_1x128x62,
     nullptr},
    {"gemv_mx_fp8_e4m3_e5m2_1x256x20", false, false, 1, 256, 20, 16, 32, 32, 256,
     LaunchTGEMV_MX_gemv_mx_fp8_e4m3_e5m2_1x256x20, nullptr},
    {"gemv_mx_bias_fp4_e1m2_1x64x62", true, true, 1, 64, 62, 16, 64, 64, 64, nullptr,
     LaunchTGEMV_MX_gemv_mx_bias_fp4_e1m2_1x64x62},
    {"gemv_mx_bias_fp4_e1m2_1x2048x64", true, true, 1, 2048, 64, 16, 64, 64, 2048, nullptr,
     LaunchTGEMV_MX_gemv_mx_bias_fp4_e1m2_1x2048x64},
};
...
static int RunCase(const TestCase& tc, int deviceId, aclrtStream stream)
{
    ...
    size_t aFileSize = aBytes, bFileSize = bBytes, scaleAFileSize = scaleABytes, scaleBFileSize = scaleBBytes,
           biasFileSize = biasBytes;
