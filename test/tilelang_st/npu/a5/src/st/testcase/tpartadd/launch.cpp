...
extern "C" __global__ AICORE void TPARTADD_f16_8x48_src0_col_less(
...
{
    TPARTADD_f16_8x48_src0_col_less<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)a, (__gm__ uint16_t*)b, (__gm__ uint16_t*)c);
}

// Case 6: f16 8x768 src0 col less
extern "C" __global__ AICORE void TPARTADD_f16_8x768_src0_col_less(
    __gm__ uint16_t* a, __gm__ uint16_t* b, __gm__ uint16_t* c);

void LaunchTPARTADD_f16_8x768_src0_col_less(uint16_t* a, uint16_t* b, uint16_t* c, void* stream)
{
    TPARTADD_f16_8x768_src0_col_less<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)a, (__gm__ uint16_t*)b, (__gm__ uint16_t*)c);
}

// Case 7: i16 8x48 src1 col less
extern "C" __global__ AICORE void TPARTADD_i16_8x48_src1_col_less(
...
extern "C" __global__ AICORE void TPARTADD_i32_64x64_src0_row_less(
...
{
    TPARTADD_i32_64x64_src0_row_less<<<1, nullptr, stream>>>(
        (__gm__ int32_t*)a, (__gm__ int32_t*)b, (__gm__ int32_t*)c);
}
