...
// Case 1: f16 63x64
extern "C" __global__ AICORE void TDIVS_f16_63x64(
...
{
    TDIVS_f16_63x64<<<1, nullptr, stream>>>(
...
extern "C" __global__ AICORE void TDIVS_f16_63x64_scalar_src(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_63x64_scalar_src(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_63x64_scalar_src<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x4200);
}
...
extern "C" __global__ AICORE void TDIVS_f16_63x64_hp(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_63x64_hp(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_63x64_hp<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x4200);
}
...
extern "C" __global__ AICORE void TDIVS_f16_16x64_hp_subnormal(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_16x64_hp_subnormal(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_16x64_hp_subnormal<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x4900);
}
...
{
    TDIVS_f32_16x64_hp_overflow<<<1, nullptr, stream>>>(
        (__gm__ float*)src, (__gm__ float*)dst, bits_to_float(0x0DA24260U));
}

// Case 13: f16 16x64 HP overflow - scalar=np.float16(0.0001) -> hex 0x068E
extern "C" __global__ AICORE void TDIVS_f16_16x64_hp_overflow(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_16x64_hp_overflow(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_16x64_hp_overflow<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x068E);
}
...
extern "C" __global__ AICORE void TDIVS_f16_63x64_hp_scalar_src(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_63x64_hp_scalar_src(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_63x64_hp_scalar_src<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x3C00);
}

// Case 16: f32 16x64 HP subnormal scalar/src - scalar=np.float32(1e-20) -> hex 0x1E3CE508
extern "C" __global__ AICORE void TDIVS_f32_16x64_hp_subnormal_scalar_src(
    __gm__ float* src, __gm__ float* dst, float scalar);
void LaunchTDIVS_f32_16x64_hp_subnormal_scalar_src(float* src, float* dst, void* stream)
{
    TDIVS_f32_16x64_hp_subnormal_scalar_src<<<1, nullptr, stream>>>(
        (__gm__ float*)src, (__gm__ float*)dst, bits_to_float(0x1E3CE508U));
}

// Case 17: f16 16x64 HP subnormal scalar/src - scalar=np.float16(1e-5) -> hex 0x00A8
extern "C" __global__ AICORE void TDIVS_f16_16x64_hp_subnormal_scalar_src(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_16x64_hp_subnormal_scalar_src(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_16x64_hp_subnormal_scalar_src<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x00A8);
}

// Case 18: f32 16x64 HP overflow scalar/src - scalar=np.float32(1e38) -> hex 0x7E967699
extern "C" __global__ AICORE void TDIVS_f32_16x64_hp_overflow_scalar_src(
    __gm__ float* src, __gm__ float* dst, float scalar);
void LaunchTDIVS_f32_16x64_hp_overflow_scalar_src(float* src, float* dst, void* stream)
{
    TDIVS_f32_16x64_hp_overflow_scalar_src<<<1, nullptr, stream>>>(
        (__gm__ float*)src, (__gm__ float*)dst, bits_to_float(0x7E967699U));
}

// Case 19: f16 16x64 HP overflow scalar/src - scalar=np.float16(65000) -> hex 0x7BEF
extern "C" __global__ AICORE void TDIVS_f16_16x64_hp_overflow_scalar_src(
    __gm__ unsigned short* src, __gm__ unsigned short* dst, unsigned short scalar);
void LaunchTDIVS_f16_16x64_hp_overflow_scalar_src(unsigned short* src, unsigned short* dst, void* stream)
{
    TDIVS_f16_16x64_hp_overflow_scalar_src<<<1, nullptr, stream>>>(
        (__gm__ unsigned short*)src, (__gm__ unsigned short*)dst, (unsigned short)0x7BEF);
}
