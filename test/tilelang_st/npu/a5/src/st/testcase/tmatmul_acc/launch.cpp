...
extern "C" __global__ AICORE void TMATMUL_ACC_f16_16x32x16(
    __gm__ uint16_t* a1, __gm__ uint16_t* b1, __gm__ uint16_t* a2, __gm__ uint16_t* b2, __gm__ float* c);
extern "C" __global__ AICORE void TMATMUL_ACC_f16_128x128x64(
    __gm__ uint16_t* a1, __gm__ uint16_t* b1, __gm__ uint16_t* a2, __gm__ uint16_t* b2, __gm__ float* c);
extern "C" __global__ AICORE void TMATMUL_ACC_f16_127x128x61(
    __gm__ uint16_t* a1, __gm__ uint16_t* b1, __gm__ uint16_t* a2, __gm__ uint16_t* b2, __gm__ float* c);
