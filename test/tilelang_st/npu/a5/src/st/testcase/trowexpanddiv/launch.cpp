...
extern "C" __global__ AICORE void TROWEXPANDDIV_f32_16x128_noeq(
...
extern "C" __global__ AICORE void TROWEXPANDDIV_f16_16x32(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);
extern "C" __global__ AICORE void TROWEXPANDDIV_f16_32x512(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);
extern "C" __global__ AICORE void TROWEXPANDDIV_f16_32x64_noeq(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);
extern "C" __global__ AICORE void TROWEXPANDDIV_f16_16x128_hp(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);

void LaunchTROWEXPANDDIV_f16_16x32(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDDIV_f16_16x32<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
void LaunchTROWEXPANDDIV_f16_32x512(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDDIV_f16_32x512<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
void LaunchTROWEXPANDDIV_f16_32x64_noeq(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDDIV_f16_32x64_noeq<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
void LaunchTROWEXPANDDIV_f16_16x128_hp(void* src0, void* src1, void* dst, void* stream)
{
    TROWEXPANDDIV_f16_16x128_hp<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
