...
extern "C" __global__ AICORE void TMATMUL_f8e4m3_f8e5m2_128x96x64(
    __gm__ uint8_t* a, __gm__ uint8_t* b, __gm__ float* c);
...
extern "C" __global__ AICORE void TMATMUL_f8e5m2_f8e4m3_145x115x85(
    __gm__ uint8_t* a, __gm__ uint8_t* b, __gm__ float* c);
