...
extern "C" __global__ AICORE void TSORT32_f32_2x64_shared_idx(
    __gm__ float* src, __gm__ uint32_t* idx, __gm__ float* dst);
...
extern "C" __global__ AICORE void TSORT32_f32_16x64_shared_idx(
    __gm__ float* src, __gm__ uint32_t* idx, __gm__ float* dst);
