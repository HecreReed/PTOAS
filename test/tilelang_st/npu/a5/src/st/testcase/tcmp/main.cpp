...
static const TestCase kCases[] = {
    ...
    {"f16_32x32_eq", (void (*)(void*, void*, void*, void*))LaunchTCMP_f16_32x32_eq, 32, 32, sizeof(uint16_t),
     sizeof(int8_t)},
    ...
    {"i32_4x64_ne", (void (*)(void*, void*, void*, void*))LaunchTCMP_i32_4x64_ne, 4, 64, sizeof(int32_t),
     sizeof(int8_t)},
    // Case 4: i32 128x128 lt with valid 64x64 (int32_128x128_64x64)
    {"i32_128x128_lt", (void (*)(void*, void*, void*, void*))LaunchTCMP_i32_128x128_lt, 128, 128, sizeof(int32_t),
     sizeof(int8_t)},
    // Case 5: i32 64x64 eq with valid 32x32 (int32_64x64_32x32)
    {"i32_64x64_eq", (void (*)(void*, void*, void*, void*))LaunchTCMP_i32_64x64_eq, 64, 64, sizeof(int32_t),
     sizeof(int8_t)},
    // Case 6: i32 16x32 eq (int32_16x32_16x32)
    {"i32_16x32_eq", (void (*)(void*, void*, void*, void*))LaunchTCMP_i32_16x32_eq, 16, 32, sizeof(int32_t),
     sizeof(int8_t)},
    // Case 7: f32 128x128 le with valid 64x64 (float_128x128_64x64)
    {"f32_128x128_le", (void (*)(void*, void*, void*, void*))LaunchTCMP_f32_128x128_le, 128, 128, sizeof(float),
     sizeof(int8_t)},
    // Case 8: i32 77x96 eq with valid 32x32 (int32_77x96_32x32)
    {"i32_77x96_eq", (void (*)(void*, void*, void*, void*))LaunchTCMP_i32_77x96_eq, 77, 96, sizeof(int32_t),
     sizeof(int8_t)},
    // Case 9: i32 32x32 eq (int32_32x32_32x32)
    {"i32_32x32_eq", (void (*)(void*, void*, void*, void*))LaunchTCMP_i32_32x32_eq, 32, 32, sizeof(int32_t),
     sizeof(int8_t)},
    // Case 10: i16 32x32 eq with valid 16x32 (int16_32x32_16x32)
    {"i16_32x32_eq", (void (*)(void*, void*, void*, void*))LaunchTCMP_i16_32x32_eq, 32, 32, sizeof(int16_t),
     sizeof(int8_t)},
    // Case 11: i16 77x96 le with valid 32x32 (int16_77x96_32x32)
    {"i16_77x96_le", (void (*)(void*, void*, void*, void*))LaunchTCMP_i16_77x96_le, 77, 96, sizeof(int16_t),
     sizeof(int8_t)},
};
