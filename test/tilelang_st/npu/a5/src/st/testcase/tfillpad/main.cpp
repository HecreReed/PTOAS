...
static const TestCase kCases[] = {
    ...
    {"f32_128x128_pad_128x127", DataType::F32,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<float>(src, dst, stream, LaunchTFILLPAD_f32_128x128_pad_128x127);
     },
    ...
    {"f32_128x160_pad_128x127", DataType::F32,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<float>(src, dst, stream, LaunchTFILLPAD_f32_128x160_pad_128x127);
     },
    ...
    {"f32_128x160_pad_128x127_v2", DataType::F32,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<float>(src, dst, stream, LaunchTFILLPAD_f32_128x160_pad_128x127_v2);
     },
     128, 160, 128, 160, 128, 127, sizeof(float)}, // CHANGED: validCols=160, srcCols=127
    ...
    {"u16_260x32_pad_260x7", DataType::U16,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<uint16_t>(src, dst, stream, LaunchTFILLPAD_u16_260x32_pad_260x7);
     },
    ...
    {"s8_260x64_pad_260x7", DataType::S8,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<int8_t>(src, dst, stream, LaunchTFILLPAD_s8_260x64_pad_260x7);
     },
    ...
    {"s16_260x32_pad_260x7", DataType::S16,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<int16_t>(src, dst, stream, LaunchTFILLPAD_s16_260x32_pad_260x7);
     },
    ...
    {"s32_260x32_pad_260x7", DataType::S32,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<int32_t>(src, dst, stream, LaunchTFILLPAD_s32_260x32_pad_260x7);
     },
    ...
    {"f32_128x128_pad_128x64_neg1", DataType::F32,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<float>(src, dst, stream, LaunchTFILLPAD_f32_128x128_pad_128x64_neg1);
     },
    ...
    {"f32_128x160_pad_128x127_neg1", DataType::F32,
     [](void* src, void* dst, void* stream) {
         wrapLaunch<float>(src, dst, stream, LaunchTFILLPAD_f32_128x160_pad_128x127_neg1);
     },
