...
extern "C" __global__ AICORE void TROWARGMAX_uint32_float_1024x1_1023x24_1023x17(
...
extern "C" __global__ AICORE void TROWARGMAX_uint32_half_272x1_260x64_260x64(
...
extern "C" __global__ AICORE void TROWARGMAX_uint32_half_16x1_1x16384_1x16381(
    __gm__ uint16_t* src, __gm__ uint32_t* dst);
...
extern "C" __global__ AICORE void TROWARGMAX_uint32_half_16x1_1x32768_1x32761(
    __gm__ uint16_t* src, __gm__ uint32_t* dst);
...
extern "C" __global__ AICORE void TROWARGMAX_uint32_float_1023x8_1023x24_1023x17(
    __gm__ float* src, __gm__ uint32_t* dst);
...
extern "C" __global__ AICORE void TROWARGMAX_uint32_half_260x16_260x64_260x64(
    __gm__ uint16_t* src, __gm__ uint32_t* dst);
...
extern "C" __global__ AICORE void TROWARGMAX_uint32_half_1023x16_1023x32_1023x17(
    __gm__ uint16_t* src, __gm__ uint32_t* dst);
void LaunchTROWARGMAX_uint32_half_1023x16_1023x32_1023x17(uint16_t* src, uint32_t* dst, void* stream)
{
    TROWARGMAX_uint32_half_1023x16_1023x32_1023x17<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src, (__gm__ uint32_t*)dst);
}
