...
static const TestCase kCases[] = {
    {"f32_64x64_full", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_f32_64x64_full), 64, 64, 64, 64, 64, 64, 64, 64,
     sizeof(float)},
    {"f32_2x24_src1_col_less", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_f32_2x24_src1_col_less), 2, 24, 2, 24, 2, 8, 2,
     24, sizeof(float)},
    {"f32_128x64_src1_row_less", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_f32_128x64_src1_row_less), 128, 64, 128, 64,
     96, 64, 128, 64, sizeof(float)},
    {"f32_95x95_full", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_f32_95x95_full), 95, 95, 95, 95, 95, 95, 95, 95,
     sizeof(float)},
    {"f32_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_f32_122x123_complex), 122, 123, 104, 123, 122,
     110, 122, 123, sizeof(float)},
    {"f16_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_f16_122x123_complex), 122, 123, 104, 123, 122,
     110, 122, 123, sizeof(uint16_t)},
    {"i16_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_i16_122x123_complex), 122, 123, 104, 123, 122,
     110, 122, 123, sizeof(int16_t)},
    {"i32_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_i32_122x123_complex), 122, 123, 104, 123, 122,
     110, 122, 123, sizeof(int32_t)},
    {"u16_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_u16_122x123_complex), 122, 123, 104, 123, 122,
     110, 122, 123, sizeof(uint16_t)},
    {"u32_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_u32_122x123_complex), 122, 123, 104, 123, 122,
     110, 122, 123, sizeof(uint32_t)},
    {"i8_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_i8_122x123_complex), 122, 123, 104, 123, 122, 110,
     122, 123, sizeof(int8_t)},
    {"u8_122x123_complex", reinterpret_cast<LaunchFn>(LaunchTPARTMIN_u8_122x123_complex), 122, 123, 104, 123, 122, 110,
