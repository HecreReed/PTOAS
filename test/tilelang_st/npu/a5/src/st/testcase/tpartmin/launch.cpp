...
extern "C" __global__ AICORE void TPARTMIN_f16_122x123_complex(
...
extern "C" __global__ AICORE void TPARTMIN_u16_122x123_complex(
    __gm__ uint16_t* a, __gm__ uint16_t* b, __gm__ uint16_t* c);
...
extern "C" __global__ AICORE void TPARTMIN_u32_122x123_complex(
    __gm__ uint32_t* a, __gm__ uint32_t* b, __gm__ uint32_t* c);
