...
extern "C" __global__ AICORE void TCOLEXPANDMIN_fp32_16_128_1_128(
...
{
    TCOLEXPANDMIN_fp32_16_128_1_128<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)dst);
}
...
extern "C" __global__ AICORE void TCOLEXPANDMIN_fp16_4_256_1_256(
...
{
    TCOLEXPANDMIN_fp16_4_256_1_256<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}

// Case 4: fp16_10_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDMIN_fp16_10_64_1_64(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);

void LaunchTCOLEXPANDMIN_fp16_10_64_1_64(uint16_t* src0, uint16_t* src1, uint16_t* dst, void* stream)
{
    TCOLEXPANDMIN_fp16_10_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
// Case: int32_16_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDMIN_int32_16_32_1_32(
...
{
    TCOLEXPANDMIN_int32_16_32_1_32<<<1, nullptr, stream>>>(
        (__gm__ int32_t*)src0, (__gm__ int32_t*)src1, (__gm__ int32_t*)dst);
}

// Case: int16_16_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDMIN_int16_16_64_1_64(
...
{
    TCOLEXPANDMIN_int16_16_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ int16_t*)src0, (__gm__ int16_t*)src1, (__gm__ int16_t*)dst);
}
