...
{
    TSTORE_ACC2GM_f16_f32_f32_nz2nd<<<1, nullptr, stream>>>((__gm__ float*)dst, (__gm__ float*)x1, (__gm__ float*)x2);
}

// Case 1: f16 src, f16 dst (3 void* args)
extern "C" __global__ AICORE void TSTORE_ACC2GM_f16_f32_f16_nz2nd(__gm__ half* dst, __gm__ half* x1, __gm__ half* x2);

void LaunchTSTORE_ACC2GM_f16_f32_f16_nz2nd(void* dst, void* x1, void* x2, void* stream)
{
    TSTORE_ACC2GM_f16_f32_f16_nz2nd<<<1, nullptr, stream>>>((__gm__ half*)dst, (__gm__ half*)x1, (__gm__ half*)x2);
}
...
extern "C" __global__ AICORE void TSTORE_ACC2GM_f16_f32_f32_nz2dn(__gm__ float* dst, __gm__ half* x1, __gm__ half* x2);

void LaunchTSTORE_ACC2GM_f16_f32_f32_nz2dn(float* dst, float* x1, float* x2, void* stream)
{
    TSTORE_ACC2GM_f16_f32_f32_nz2dn<<<1, nullptr, stream>>>((__gm__ float*)dst, (__gm__ half*)x1, (__gm__ half*)x2);
}
...
extern "C" __global__ AICORE void TSTORE_ACC2GM_f16_f32_f32_nz2nz(__gm__ float* dst, __gm__ half* x1, __gm__ half* x2);

void LaunchTSTORE_ACC2GM_f16_f32_f32_nz2nz(float* dst, float* x1, float* x2, void* stream)
{
    TSTORE_ACC2GM_f16_f32_f32_nz2nz<<<1, nullptr, stream>>>((__gm__ float*)dst, (__gm__ half*)x1, (__gm__ half*)x2);
}
