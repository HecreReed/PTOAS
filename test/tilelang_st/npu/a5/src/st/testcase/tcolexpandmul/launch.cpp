...
extern "C" __global__ AICORE void TCOLEXPANDMUL_fp32_16_128_1_128(
...
{
    TCOLEXPANDMUL_fp32_16_128_1_128<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)dst);
}

// Case 2: fp32_32_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDMUL_fp32_32_32_1_32(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* dst);
...
extern "C" __global__ AICORE void TCOLEXPANDMUL_fp16_4_256_1_256(
...
{
    TCOLEXPANDMUL_fp16_4_256_1_256<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
...
{
    TCOLEXPANDMUL_int16_16_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ int16_t*)src0, (__gm__ int16_t*)src1, (__gm__ int16_t*)dst);
}
