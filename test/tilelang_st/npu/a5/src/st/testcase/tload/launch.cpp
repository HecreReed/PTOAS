...
extern "C" __global__ AICORE void TLOAD_ND_f8e4m3_16x64(__gm__ float8_e4m3_t* src, __gm__ float8_e4m3_t* dst);
extern "C" __global__ AICORE void TLOAD_ND_hif8_16x64(__gm__ hifloat8_t* src, __gm__ hifloat8_t* dst);
...
{
    TLOAD_ND_f8e4m3_16x64<<<1, nullptr, stream>>>((__gm__ float8_e4m3_t*)src, (__gm__ float8_e4m3_t*)dst);
}

void LaunchTLOAD_ND_hif8_16x64(uint8_t* src, uint8_t* dst, void* stream)
{
    TLOAD_ND_hif8_16x64<<<1, nullptr, stream>>>((__gm__ hifloat8_t*)src, (__gm__ hifloat8_t*)dst);
}
