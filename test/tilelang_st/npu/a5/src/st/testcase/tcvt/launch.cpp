...
extern "C" __global__ AICORE void TCVT_bf16_to_f4e1m2x2_16x64_to_16x32(
    __gm__ uint16_t* src, __gm__ float4_e1m2x2_t* dst);
extern "C" __global__ AICORE void TCVT_bf16_to_f4e2m1x2_16x64_to_16x32(
    __gm__ uint16_t* src, __gm__ float4_e2m1x2_t* dst);
