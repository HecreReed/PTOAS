...
static const TestCase kCases[] = {
    {"fp32_16_128_1_128", (LaunchFn)LaunchTCOLEXPANDMAX_fp32_16_128_1_128, 16, 128, 1, 128, 16, 128, 16, 128,
     sizeof(float)},
    {"fp32_32_32_1_32", (LaunchFn)LaunchTCOLEXPANDMAX_fp32_32_32_1_32, 32, 32, 1, 32, 32, 32, 32, 32, sizeof(float)},
    {"fp16_4_256_1_256", (LaunchFn)LaunchTCOLEXPANDMAX_fp16_4_256_1_256, 4, 256, 1, 256, 4, 256, 4, 256,
     sizeof(uint16_t)},
    {"fp16_10_64_1_64", (LaunchFn)LaunchTCOLEXPANDMAX_fp16_10_64_1_64, 10, 64, 1, 64, 10, 64, 10, 64, sizeof(uint16_t)},
    {"int32_16_32_1_32", (LaunchFn)LaunchTCOLEXPANDMAX_int32_16_32_1_32, 16, 32, 1, 32, 16, 32, 16, 32,
     sizeof(int32_t)},
    {"int16_16_64_1_64", (LaunchFn)LaunchTCOLEXPANDMAX_int16_16_64_1_64, 16, 64, 1, 64, 16, 64, 16, 64,
     sizeof(int16_t)},
};
...
static int RunCase(const TestCase& tc, int deviceId, aclrtStream stream)
{
    ...
    std::printf(
        "[INFO] === case: %s (src0=%zux%zu, src1=%zux%zu -> dst=%zux%zu, valid=%zux%zu) ===\n", tc.name, tc.src0Rows,
        tc.src0Cols, tc.src1Rows, tc.src1Cols, tc.dstRows, tc.dstCols, tc.validRows, tc.validCols);
