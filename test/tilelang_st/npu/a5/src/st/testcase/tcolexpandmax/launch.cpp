...
extern "C" __global__ AICORE void TCOLEXPANDMAX_fp32_16_128_1_128(
...
{
    TCOLEXPANDMAX_fp32_16_128_1_128<<<1, nullptr, stream>>>(
        (__gm__ float*)src0, (__gm__ float*)src1, (__gm__ float*)dst);
}

// Case 2: fp32_32_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDMAX_fp32_32_32_1_32(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* dst);
...
extern "C" __global__ AICORE void TCOLEXPANDMAX_fp16_4_256_1_256(
...
{
    TCOLEXPANDMAX_fp16_4_256_1_256<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}

// Case 4: fp16_10_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDMAX_fp16_10_64_1_64(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);

void LaunchTCOLEXPANDMAX_fp16_10_64_1_64(uint16_t* src0, uint16_t* src1, uint16_t* dst, void* stream)
{
    TCOLEXPANDMAX_fp16_10_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
// Case: int32_16_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDMAX_int32_16_32_1_32(
...
{
    TCOLEXPANDMAX_int32_16_32_1_32<<<1, nullptr, stream>>>(
        (__gm__ int32_t*)src0, (__gm__ int32_t*)src1, (__gm__ int32_t*)dst);
}

// Case: int16_16_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDMAX_int16_16_64_1_64(
...
{
    TCOLEXPANDMAX_int16_16_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ int16_t*)src0, (__gm__ int16_t*)src1, (__gm__ int16_t*)dst);
}
