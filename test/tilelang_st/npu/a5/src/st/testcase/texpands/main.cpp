...
static const TestCase kCases[] = {
    ...
    {"f32_16x64_scalar5", DataType::F32,
     [](void* dst, void* stream) { wrapLaunch<float>(dst, stream, LaunchTEXPANDS_f32_16x64_scalar5); }, 16, 64, 16, 64,
     sizeof(float)},
    {"f32_32x32_scalar3", DataType::F32,
     [](void* dst, void* stream) { wrapLaunch<float>(dst, stream, LaunchTEXPANDS_f32_32x32_scalar3); }, 32, 32, 32, 32,
     sizeof(float)},
    {"f32_64x64_scalar2", DataType::F32,
     [](void* dst, void* stream) { wrapLaunch<float>(dst, stream, LaunchTEXPANDS_f32_64x64_scalar2); }, 64, 64, 64, 64,
     sizeof(float)},
    {"f32_16x64_partial", DataType::F32,
     [](void* dst, void* stream) { wrapLaunch<float>(dst, stream, LaunchTEXPANDS_f32_16x64_partial); }, 16, 64, 12, 48,
     sizeof(float)},
    {"f32_64x64_valid_60x60", DataType::F32,
     [](void* dst, void* stream) { wrapLaunch<float>(dst, stream, LaunchTEXPANDS_f32_64x64_valid_60x60); }, 64, 64, 60,
     60, sizeof(float)},

    // ========== int32 cases ==========
    {"i32_64x64_scalar100", DataType::I32,
     [](void* dst, void* stream) { wrapLaunch<int32_t>(dst, stream, LaunchTEXPANDS_i32_64x64_scalar100); }, 64, 64, 64,
     64, sizeof(int32_t)},
    {"i32_64x64_valid_60x60", DataType::I32,
     [](void* dst, void* stream) { wrapLaunch<int32_t>(dst, stream, LaunchTEXPANDS_i32_64x64_valid_60x60); }, 64, 64,
     60, 60, sizeof(int32_t)},

    // ========== half (fp16) cases ==========
    {"f16_64x64_scalar1_5", DataType::F16,
     [](void* dst, void* stream) { wrapLaunch<uint16_t>(dst, stream, LaunchTEXPANDS_f16_64x64_scalar1_5); }, 64, 64, 64,
     64, sizeof(uint16_t)},
    {"f16_2x4096_valid_1x3600", DataType::F16,
     [](void* dst, void* stream) { wrapLaunch<uint16_t>(dst, stream, LaunchTEXPANDS_f16_2x4096_valid_1x3600); }, 2,
     4096, 1, 3600, sizeof(uint16_t)},

    // ========== int16 cases ==========
    {"i16_64x64_scalar50", DataType::I16,
     [](void* dst, void* stream) { wrapLaunch<int16_t>(dst, stream, LaunchTEXPANDS_i16_64x64_scalar50); }, 64, 64, 64,
     64, sizeof(int16_t)},
    {"i16_20x512_valid_16x200", DataType::I16,
     [](void* dst, void* stream) { wrapLaunch<int16_t>(dst, stream, LaunchTEXPANDS_i16_20x512_valid_16x200); }, 20, 512,
     16, 200, sizeof(int16_t)},
};
