...
extern "C" __global__ AICORE void TGEMV_f16_1x300x60(
    __gm__ uint16_t* a0, __gm__ uint16_t* b0, __gm__ uint16_t* a1, __gm__ uint16_t* b1, __gm__ float* c);
void LaunchTGEMV_f16_1x300x60(void* a, void* b, void* c, void* stream)
{
    ...
    TGEMV_f16_1x300x60<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)(a_), (__gm__ uint16_t*)(b_), (__gm__ uint16_t*)(a_ + 256), (__gm__ uint16_t*)(b_ + 256 * 64),
        (__gm__ float*)c);
}

// ---- case2: TGEMV_BIAS + TGEMV_ACC f16, 1x512x85, split-K BASEK=256 ----
extern "C" __global__ AICORE void TGEMV_BIAS_f16_1x512x85(
