...
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_32_64_1_64(
...
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_8_32_1_32(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* dst);
...
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp16_16_64_1_64(
...
{
    TCOLEXPANDDIV_fp16_16_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}

// Case 4: fp16_4_128_1_128
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp16_4_128_1_128(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);

void LaunchTCOLEXPANDDIV_fp16_4_128_1_128(uint16_t* src0, uint16_t* src1, uint16_t* dst, void* stream)
{
    TCOLEXPANDDIV_fp16_4_128_1_128<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}
// Case: int32_16_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDDIV_int32_16_32_1_32(
...
{
    TCOLEXPANDDIV_int32_16_32_1_32<<<1, nullptr, stream>>>(
        (__gm__ int32_t*)src0, (__gm__ int32_t*)src1, (__gm__ int32_t*)dst);
}

// Case: int16_16_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDDIV_int16_16_64_1_64(
...
{
    TCOLEXPANDDIV_int16_16_64_1_64<<<1, nullptr, stream>>>(
        (__gm__ int16_t*)src0, (__gm__ int16_t*)src1, (__gm__ int16_t*)dst);
}

// Case: fp32_40_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_40_32_1_32(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* dst);
...
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp16_16_128_1_128(
    __gm__ uint16_t* src0, __gm__ uint16_t* src1, __gm__ uint16_t* dst);

void LaunchTCOLEXPANDDIV_fp16_16_128_1_128(uint16_t* src0, uint16_t* src1, uint16_t* dst, void* stream)
{
    TCOLEXPANDDIV_fp16_16_128_1_128<<<1, nullptr, stream>>>(
        (__gm__ uint16_t*)src0, (__gm__ uint16_t*)src1, (__gm__ uint16_t*)dst);
}

// Case: fp32_20_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_20_64_1_64(
    __gm__ float* src0, __gm__ float* src1, __gm__ float* dst);
