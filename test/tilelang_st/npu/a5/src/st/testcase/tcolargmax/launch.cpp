...
extern "C" __global__ AICORE void TCOLARGMAX_ui32_16x128(
    __gm__ int32_t* dst, __gm__ uint32_t* tmp, __gm__ uint32_t* src);
...
extern "C" __global__ AICORE void TCOLARGMAX_ui32_16x256(
    __gm__ int32_t* dst, __gm__ uint32_t* tmp, __gm__ uint32_t* src);
...
extern "C" __global__ AICORE void TCOLARGMAX_ui16_1x256(
...
extern "C" __global__ AICORE void TCOLARGMAX_ui16_16x128(
    __gm__ int32_t* dst, __gm__ uint16_t* tmp, __gm__ uint16_t* src);
...
extern "C" __global__ AICORE void TCOLARGMAX_ui16_16x256(
    __gm__ int32_t* dst, __gm__ uint16_t* tmp, __gm__ uint16_t* src);
