...
void LaunchSOFTMAX_f32_rows24_seq73(
    float* v1, float* v2, float* v3, float* v4, float* v5, float* v6, float* v7, int32_t v8, int32_t v9, void* stream);
void LaunchSOFTMAX_f32_rows8_seq32(
    float* v1, float* v2, float* v3, float* v4, float* v5, float* v6, float* v7, int32_t v8, int32_t v9, void* stream);

using LaunchFn = void (*)(float*, float*, float*, float*, float*, float*, float*, int32_t, int32_t, void*);
...
static int RunCase(const TestCase& tc, aclrtStream stream)
{
    ...
    tc.launch(v1Device, v2Device, v3Device, v4Device, v5Device, v6Device, v7Device, seqHost, rowsHost, stream);
    ...
    if (!WriteFile(caseDir + "/v4.bin", v4Host, stateBytes) || !WriteFile(caseDir + "/v5.bin", v5Host, stateBytes) ||
        !WriteFile(caseDir + "/v6.bin", v6Host, stateBytes) || !WriteFile(caseDir + "/v7.bin", v7Host, outBytes)) {
