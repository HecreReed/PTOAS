...
"""Single source of truth for trowprod ST test cases.

Aligned with pto-isa tests/npu/a5/src/st/testcase/trowprod (18 cases).
"""
...
CASES = [
    ...
    # f32 DN dst cases (case7-case10 from pto-isa)
    {
        "name": "f32_64x128",
        "dtype": np.float32,
        "shape": (64, 128),
