    ...
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            with InsertionPoint(entry):
                ...
                # Sync: PIPE_MTE2 (TLOAD) -> PIPE_MTE1 (TMOV)
                ...
                # Sync: PIPE_MTE1 (TEXTRACT/TMOV) -> PIPE_M (use TMATMUL as PIPE_M proxy)
                ...
                # Sync: PIPE_M -> PIPE_MTE2 (TLOAD) before the next chunk.
                ...
                # Sync: PIPE_M -> PIPE_FIX (TSTORE_ACC)
