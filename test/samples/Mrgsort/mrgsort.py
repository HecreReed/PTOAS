...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            # TMrgSort requires a single-row Vec tile. Represent the input as a
            # 1x1024 tensor view to match the tile shape on A5.
            ...
            with InsertionPoint(entry):
                ...
                # %0/%1 = pto.make_tensor_view %arg?, shape=[%c1,%c1024] strides=[%c1024,%c1]
                ...
                # %2 = pto.partition_view %tv, offsets=[%c0,%c0], sizes=[%c1,%c1024]
                ...
                # partition_view on output tensor_view
