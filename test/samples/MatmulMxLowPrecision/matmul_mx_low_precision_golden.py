...
def main():
    ...
    a_scale_buffer = np.zeros(
        meta.elem_counts[a_scale_name], dtype=meta.np_types[a_scale_name]
    )
    a_scale_buffer[: packed_a_scale.size] = packed_a_scale
    buffers[a_scale_name] = a_scale_buffer
