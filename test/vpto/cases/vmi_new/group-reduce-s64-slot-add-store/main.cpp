...
void LaunchVmi_group_reduce_s64_slot_add_store_kernel(float* src, float* rhs, float* dst, void* stream);
...
int main()
{
    ...
    LaunchVmi_group_reduce_s64_slot_add_store_kernel(srcDevice, rhsDevice, dstDevice, stream);
