...
void LaunchVmi_group_broadcast_multi_consumer_kernel(float* src, float* sum, uint16_t* dense, void* stream);
...
int main()
{
    ...
    LaunchVmi_group_broadcast_multi_consumer_kernel(srcDevice, sumDevice, denseDevice, stream);
