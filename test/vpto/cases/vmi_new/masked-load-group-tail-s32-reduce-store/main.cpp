...
void LaunchVmi_masked_load_group_tail_s32_reduce_store_kernel(float* src, float* copy, float* sum, void* stream);
...
int main()
{
    ...
    LaunchVmi_masked_load_group_tail_s32_reduce_store_kernel(srcDevice, copyDevice, sumDevice, stream);
