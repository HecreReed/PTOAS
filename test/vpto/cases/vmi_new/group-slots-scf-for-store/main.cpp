...
void LaunchVmi_group_slots_scf_for_store_kernel(float* init, float* src, float* dst, void* stream);
...
int main()
{
    ...
    ACL_CHECK(aclrtMemcpy(initDevice, initBytes, initHost, initBytes, ACL_MEMCPY_HOST_TO_DEVICE));
    ...
    LaunchVmi_group_slots_scf_for_store_kernel(initDevice, srcDevice, dstDevice, stream);
