...
void LaunchVmi_dense_group_reduce_multi_consumer_kernel(float* src, float* sum, float* copy, void* stream);
...
int main()
{
    ...
    LaunchVmi_dense_group_reduce_multi_consumer_kernel(srcDevice, sumDevice, copyDevice, stream);
