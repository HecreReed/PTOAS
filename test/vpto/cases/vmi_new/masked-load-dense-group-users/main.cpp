...
void LaunchVmi_masked_load_dense_group_users_kernel(float* src, float* copy, float* sum, void* stream);
...
int main()
{
    ...
    LaunchVmi_masked_load_dense_group_users_kernel(srcDevice, copyDevice, sumDevice, stream);
