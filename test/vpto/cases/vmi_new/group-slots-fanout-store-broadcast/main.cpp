...
void LaunchVmi_group_slots_fanout_store_broadcast_kernel(float* src, float* sum, float* out, void* stream);
...
int main()
{
    ...
    LaunchVmi_group_slots_fanout_store_broadcast_kernel(srcDevice, sumDevice, outDevice, stream);
