...
void LaunchVmi_f32_to_f8_store_reduce_kernel(float* src, float* sum, uint8_t* out8, void* stream);
...
int main()
{
    ...
    LaunchVmi_f32_to_f8_store_reduce_kernel(srcDevice, sumDevice, out8Device, stream);
