...
void LaunchVmi_private_call_argument_boundary_store_kernel(float* src, float* copy, float* sum, void* stream);
...
int main()
{
    ...
    LaunchVmi_private_call_argument_boundary_store_kernel(srcDevice, copyDevice, sumDevice, stream);
