...
void LaunchVmi_group_reduce_i16_extsi_i32_addi_store_kernel(int16_t* src, int32_t* dst, void* stream);
...
int main()
{
    ...
    LaunchVmi_group_reduce_i16_extsi_i32_addi_store_kernel(srcDevice, dstDevice, stream);
