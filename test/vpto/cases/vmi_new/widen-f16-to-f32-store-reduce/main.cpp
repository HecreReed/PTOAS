...
void LaunchVmi_widen_f16_to_f32_store_reduce_kernel(uint16_t* src, float* sum, float* dense, void* stream);
...
int main()
{
    ...
    LaunchVmi_widen_f16_to_f32_store_reduce_kernel(srcDevice, sumDevice, denseDevice, stream);
