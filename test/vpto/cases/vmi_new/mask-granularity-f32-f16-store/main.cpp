...
void LaunchVmi_mask_granularity_f32_f16_store_kernel(float* src, float* out32, uint16_t* out16, void* stream);
...
int main()
{
    ...
    LaunchVmi_mask_granularity_f32_f16_store_kernel(srcDevice, out32Device, out16Device, stream);
