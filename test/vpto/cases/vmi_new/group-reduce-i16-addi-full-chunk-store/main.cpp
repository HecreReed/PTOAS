...
void LaunchVmi_group_reduce_i16_addi_full_chunk_store_kernel(int16_t* src, int16_t* dst, void* stream);
...
int main()
{
    ...
    LaunchVmi_group_reduce_i16_addi_full_chunk_store_kernel(srcDevice, dstDevice, stream);
