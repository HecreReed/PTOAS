...
void LaunchVmi_block_quant_bf16_fp8_32x128_kernel(uint16_t* src, float* scale, uint8_t* out, void* stream);
...
int main()
{
    ...
    LaunchVmi_block_quant_bf16_fp8_32x128_kernel(srcDevice, scaleDevice, outDevice, stream);
