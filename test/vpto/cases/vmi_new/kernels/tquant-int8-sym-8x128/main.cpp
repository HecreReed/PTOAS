...
void LaunchVmi_tquant_int8_sym_8x128_kernel(float* src, float* inv_scale, uint8_t* dst, void* stream);
...
int main()
{
    ...
    LaunchVmi_tquant_int8_sym_8x128_kernel(srcDevice, scaleDevice, dstDevice, stream);
