...
void LaunchVmi_tquant_mxfp8_32x64_nz_kernel(
    float* src, uint16_t* idx, uint8_t* out_fp8, uint8_t* out_e8m0, void* stream);
...
int main()
{
    ...
    ACL_CHECK(aclrtMalloc((void**)&idxDevice, idxBytes, ACL_MEM_MALLOC_HUGE_FIRST));
    ...
    ACL_CHECK(aclrtMemcpy(idxDevice, idxBytes, idxHost, idxBytes, ACL_MEMCPY_HOST_TO_DEVICE));
    ...
    LaunchVmi_tquant_mxfp8_32x64_nz_kernel(srcDevice, idxDevice, outFp8Device, outE8m0Device, stream);
