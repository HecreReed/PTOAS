...
void LaunchVmi_dynamic_quant_pertoken_f16_4x32_kernel(uint16_t* src, float* scale, uint8_t* out, void* stream);
...
int main()
{
    ...
    LaunchVmi_dynamic_quant_pertoken_f16_4x32_kernel(srcDevice, scaleDevice, outDevice, stream);
