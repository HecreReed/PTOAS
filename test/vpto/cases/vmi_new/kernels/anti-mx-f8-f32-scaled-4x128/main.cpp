...
void LaunchVmi_anti_mx_f8_f32_scaled_4x128_kernel(uint8_t* src, uint8_t* mxscale, float* dst, void* stream);
...
int main()
{
    ...
    LaunchVmi_anti_mx_f8_f32_scaled_4x128_kernel(srcDevice, mxscaleDevice, dstDevice, stream);
