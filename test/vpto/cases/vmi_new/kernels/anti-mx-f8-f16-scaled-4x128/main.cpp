...
void LaunchVmi_anti_mx_f8_f16_scaled_4x128_kernel(uint8_t* src, uint8_t* mxscale, uint16_t* dst, void* stream);
...
int main()
{
    ...
    LaunchVmi_anti_mx_f8_f16_scaled_4x128_kernel(srcDevice, mxscaleDevice, dstDevice, stream);
