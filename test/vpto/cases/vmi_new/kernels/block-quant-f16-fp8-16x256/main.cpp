...
void LaunchVmi_block_quant_f16_fp8_16x256_kernel(uint16_t* src, float* scale, uint8_t* out, void* stream);
...
int main()
{
    ...
    LaunchVmi_block_quant_f16_fp8_16x256_kernel(srcDevice, scaleDevice, outDevice, stream);
