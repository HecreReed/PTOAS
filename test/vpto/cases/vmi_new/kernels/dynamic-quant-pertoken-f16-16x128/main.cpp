...
void LaunchVmi_dynamic_quant_pertoken_f16_16x128_kernel(uint16_t* src, float* scale, uint8_t* out, void* stream);
...
int main()
{
    ...
    LaunchVmi_dynamic_quant_pertoken_f16_16x128_kernel(srcDevice, scaleDevice, outDevice, stream);
