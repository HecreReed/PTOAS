...
void LaunchVmi_swiglu_mx_quant_f16_e5m2_2x256_kernel(uint16_t* src, uint8_t* out, uint8_t* scale, void* stream);
...
int main()
{
    ...
    LaunchVmi_swiglu_mx_quant_f16_e5m2_2x256_kernel(srcDevice, outDevice, scaleDevice, stream);
