...
void LaunchVmi_dynamic_quant_perchannel_f16_8x256_kernel(uint16_t* src, float* scale, uint8_t* out, void* stream);
...
int main()
{
    ...
    LaunchVmi_dynamic_quant_perchannel_f16_8x256_kernel(srcDevice, scaleDevice, outDevice, stream);
