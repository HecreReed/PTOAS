...
void LaunchVmi_simdvf_per_block_cast_to_fp8_kernel(uint16_t* src, float* scale, uint8_t* out8, void* stream);
...
int main()
{
    ...
    LaunchVmi_simdvf_per_block_cast_to_fp8_kernel(srcDevice, scaleDevice, outDevice, stream);
