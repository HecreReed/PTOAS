...
extern "C" __global__[aicore] void vlds_unpk_b16_kernel_2d(__gm__ half* v1, __gm__ half* v2);

void LaunchVlds_unpk_b16_kernel_2d(uint16_t* v1, uint16_t* v2, void* stream)
{
    vlds_unpk_b16_kernel_2d<<<1, nullptr, stream>>>((__gm__ half*)v1, (__gm__ half*)v2);
}
