...
int main()
{
    ...
    ACL_CHECK(aclrtMemcpy(addDevice, kBytes, addHost, kBytes, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(maxDevice, kBytes, maxHost, kBytes, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(minDevice, kBytes, minHost, kBytes, ACL_MEMCPY_HOST_TO_DEVICE));

    LaunchVcgGroup(srcDevice, addDevice, maxDevice, minDevice, stream);

    ACL_CHECK(aclrtSynchronizeStream(stream));
    ACL_CHECK(aclrtMemcpy(addHost, kBytes, addDevice, kBytes, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(maxHost, kBytes, maxDevice, kBytes, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(minHost, kBytes, minDevice, kBytes, ACL_MEMCPY_DEVICE_TO_HOST));
