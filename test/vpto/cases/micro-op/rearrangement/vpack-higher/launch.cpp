...
extern "C" __global__[aicore] void vpack_higher_kernel_2d(__gm__ int* v1, __gm__ uint16_t* v2);

void LaunchVpack_higher_kernel_2d(int32_t* v1, uint16_t* v2, void* stream)
{
    vpack_higher_kernel_2d<<<1, nullptr, stream>>>((__gm__ int*)v1, (__gm__ uint16_t*)v2);
}
