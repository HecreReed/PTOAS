...
extern "C" __global__[aicore] void vcvt_f16_special_kernel_2d(__gm__ half* v1, __gm__ float* v2);

void LaunchVcvt_f16_special_kernel_2d(uint16_t* v1, float* v2, void* stream)
{
    vcvt_f16_special_kernel_2d<<<1, nullptr, stream>>>((__gm__ half*)v1, (__gm__ float*)v2);
}
