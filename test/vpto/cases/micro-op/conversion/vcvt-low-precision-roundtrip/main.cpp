...
int main()
{
    ...
    const char* files[kBufferCount] = {"v1_f8e4_in.bin",  "v2_f8e5_in.bin",  "v3_hif8_in.bin",  "v4_f4e1_in.bin",
                                       "v5_f4e2_in.bin",  "v6_f8e4_out.bin", "v7_f8e5_out.bin", "v8_hif8_out.bin",
                                       "v9_f4e1_out.bin", "v10_f4e2_out.bin"};
