...
extern "C" __global__[aicore] void vcvt_f32_special_kernel_2d(__gm__ float* v1, __gm__ half* v2);

void LaunchVcvt_f32_special_kernel_2d(float* v1, uint16_t* v2, void* stream)
{
    vcvt_f32_special_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ half*)v2);
}
