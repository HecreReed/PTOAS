...
extern "C" __global__[aicore] void vaddc_kernel_2d(
    __gm__ uint32_t* v1, __gm__ uint32_t* v2, __gm__ uint32_t* v3, __gm__ uint8_t* v4);

void LaunchVaddc_kernel_2d(uint32_t* v1, uint32_t* v2, uint32_t* v3, uint8_t* v4, void* stream)
{
    vaddc_kernel_2d<<<1, nullptr, stream>>>(
        (__gm__ uint32_t*)v1, (__gm__ uint32_t*)v2, (__gm__ uint32_t*)v3, (__gm__ uint8_t*)v4);
}
