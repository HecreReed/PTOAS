...
void LaunchVorDeepMerged(
    uint16_t* p0, uint16_t* p1, uint16_t* p2, uint16_t* p3, uint16_t* p4, uint16_t* p5, uint16_t* p6, uint16_t* p7,
...
int main()
{
    ...
    LaunchVorDeepMerged(
        d_f32_v1, d_f32_v2, d_f32_v3, d_f16_v1, d_f16_v2, d_f16_v3, d_mask_edge_v1, d_mask_edge_v2, d_mask_edge_v3,
        stream);
