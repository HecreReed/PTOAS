...
void LaunchVdivDeepMerged(
    float* p0, float* p1, float* p2, uint16_t* p3, uint16_t* p4, uint16_t* p5, float* p6, float* p7, float* p8,
    float* p9, float* p10, float* p11, void* stream);
int main()
{
    ...
    LaunchVdivDeepMerged(
        d_f32_v1, d_f32_v2, d_f32_v3, d_f16_v1, d_f16_v2, d_f16_v3, d_f32_exceptional_v1, d_f32_exceptional_v2,
        d_f32_exceptional_v3, d_tail_v1, d_tail_v2, d_tail_v3, stream);
