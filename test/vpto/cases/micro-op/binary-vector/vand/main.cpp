...
void LaunchVandDeepMerged(
    uint16_t* p0, uint16_t* p1, uint16_t* p2, uint16_t* p3, uint16_t* p4, uint16_t* p5, uint8_t* p6, uint8_t* p7,
    uint8_t* p8, uint8_t* p9, uint8_t* p10, uint8_t* p11, uint8_t* p12, uint8_t* p13, uint8_t* p14, uint8_t* p15,
    void* stream);
int main()
{
    ...
    fsz = SZ_mask_edge;
    FCK(ReadFile("v1_mask_edge.bin", fsz, h_mask_edge_v1, SZ_mask_edge) && fsz == SZ_mask_edge, "v1_mask_edge.bin");
    fsz = SZ_mask_edge;
    FCK(ReadFile("v2_mask_edge.bin", fsz, h_mask_edge_v2, SZ_mask_edge) && fsz == SZ_mask_edge, "v2_mask_edge.bin");
    fsz = SZ_mask_edge;
    FCK(ReadFile("v3_mask_edge.bin", fsz, h_mask_edge_v3, SZ_mask_edge) && fsz == SZ_mask_edge, "v3_mask_edge.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v1_f8.bin", fsz, h_f8_v1, SZ_lowp) && fsz == SZ_lowp, "v1_f8.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v2_f8.bin", fsz, h_f8_v2, SZ_lowp) && fsz == SZ_lowp, "v2_f8.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v3_f8_and.bin", fsz, h_f8_and, SZ_lowp) && fsz == SZ_lowp, "v3_f8_and.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v4_f8_xor.bin", fsz, h_f8_xor, SZ_lowp) && fsz == SZ_lowp, "v4_f8_xor.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v5_f8_or.bin", fsz, h_f8_or, SZ_lowp) && fsz == SZ_lowp, "v5_f8_or.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v1_hif8.bin", fsz, h_hif8_v1, SZ_lowp) && fsz == SZ_lowp, "v1_hif8.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v2_hif8.bin", fsz, h_hif8_v2, SZ_lowp) && fsz == SZ_lowp, "v2_hif8.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v3_hif8_and.bin", fsz, h_hif8_and, SZ_lowp) && fsz == SZ_lowp, "v3_hif8_and.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v4_hif8_xor.bin", fsz, h_hif8_xor, SZ_lowp) && fsz == SZ_lowp, "v4_hif8_xor.bin");
    fsz = SZ_lowp;
    FCK(ReadFile("v5_hif8_or.bin", fsz, h_hif8_or, SZ_lowp) && fsz == SZ_lowp, "v5_hif8_or.bin");
    ...
    LaunchVandDeepMerged(
        d_f32_v1, d_f32_v2, d_f32_v3, d_mask_edge_v1, d_mask_edge_v2, d_mask_edge_v3, d_f8_v1, d_f8_v2, d_f8_and,
        d_f8_xor, d_f8_or, d_hif8_v1, d_hif8_v2, d_hif8_and, d_hif8_xor, d_hif8_or, stream);
