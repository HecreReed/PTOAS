...
void LaunchVaddDeepMerged(
    float* p0, float* p1, float* p2, uint16_t* p3, uint16_t* p4, uint16_t* p5, uint16_t* p6, uint16_t* p7, uint16_t* p8,
    float* p9, float* p10, float* p11, int16_t* p12, int16_t* p13, int16_t* p14, int16_t* p15, int16_t* p16,
    int16_t* p17, uint16_t* p18, uint16_t* p19, uint16_t* p20, uint16_t* p21, uint16_t* p22, uint16_t* p23, float* p24,
    float* p25, float* p26, void* stream);
int main()
{
    ...
    fsize = SZ_F32;
    FILE_CHECK(ReadFile("./v1.bin", fsize, h_f32_v1, SZ_F32) && fsize == SZ_F32, "./v1.bin");
    fsize = SZ_F32;
    FILE_CHECK(ReadFile("./v2.bin", fsize, h_f32_v2, SZ_F32) && fsize == SZ_F32, "./v2.bin");
    fsize = SZ_F32;
    FILE_CHECK(ReadFile("./v3.bin", fsize, h_f32_v3, SZ_F32) && fsize == SZ_F32, "./v3.bin");

    fsize = SZ_F16;
    FILE_CHECK(ReadFile("./v1_f16.bin", fsize, h_f16_v1, SZ_F16) && fsize == SZ_F16, "./v1_f16.bin");
    fsize = SZ_F16;
    FILE_CHECK(ReadFile("./v2_f16.bin", fsize, h_f16_v2, SZ_F16) && fsize == SZ_F16, "./v2_f16.bin");
    fsize = SZ_F16;
    FILE_CHECK(ReadFile("./v3_f16.bin", fsize, h_f16_v3, SZ_F16) && fsize == SZ_F16, "./v3_f16.bin");

    fsize = SZ_BF16;
    FILE_CHECK(ReadFile("./v1_bf16.bin", fsize, h_bf16_v1, SZ_BF16) && fsize == SZ_BF16, "./v1_bf16.bin");
    fsize = SZ_BF16;
    FILE_CHECK(ReadFile("./v2_bf16.bin", fsize, h_bf16_v2, SZ_BF16) && fsize == SZ_BF16, "./v2_bf16.bin");
    fsize = SZ_BF16;
    FILE_CHECK(ReadFile("./v3_bf16.bin", fsize, h_bf16_v3, SZ_BF16) && fsize == SZ_BF16, "./v3_bf16.bin");

    fsize = SZ_X;
    FILE_CHECK(ReadFile("./v1_x.bin", fsize, h_x_v1, SZ_X) && fsize == SZ_X, "./v1_x.bin");
    fsize = SZ_X;
    FILE_CHECK(ReadFile("./v2_x.bin", fsize, h_x_v2, SZ_X) && fsize == SZ_X, "./v2_x.bin");
    fsize = SZ_X;
    FILE_CHECK(ReadFile("./v3_x.bin", fsize, h_x_v3, SZ_X) && fsize == SZ_X, "./v3_x.bin");

    fsize = SZ_I16S;
    FILE_CHECK(ReadFile("./v1_i16s.bin", fsize, h_i16s_v1, SZ_I16S) && fsize == SZ_I16S, "./v1_i16s.bin");
    fsize = SZ_I16S;
    FILE_CHECK(ReadFile("./v2_i16s.bin", fsize, h_i16s_v2, SZ_I16S) && fsize == SZ_I16S, "./v2_i16s.bin");
    fsize = SZ_I16S;
    FILE_CHECK(ReadFile("./v3_i16s.bin", fsize, h_i16s_v3, SZ_I16S) && fsize == SZ_I16S, "./v3_i16s.bin");

    fsize = SZ_I16S;
    FILE_CHECK(ReadFile("./v1_i16s_ov.bin", fsize, h_i16so_v1, SZ_I16S) && fsize == SZ_I16S, "./v1_i16s_ov.bin");
    fsize = SZ_I16S;
    FILE_CHECK(ReadFile("./v2_i16s_ov.bin", fsize, h_i16so_v2, SZ_I16S) && fsize == SZ_I16S, "./v2_i16s_ov.bin");
    fsize = SZ_I16S;
    FILE_CHECK(ReadFile("./v3_i16s_ov.bin", fsize, h_i16so_v3, SZ_I16S) && fsize == SZ_I16S, "./v3_i16s_ov.bin");

    fsize = SZ_I16U;
    FILE_CHECK(ReadFile("./v1_i16u.bin", fsize, h_i16u_v1, SZ_I16U) && fsize == SZ_I16U, "./v1_i16u.bin");
    fsize = SZ_I16U;
    FILE_CHECK(ReadFile("./v2_i16u.bin", fsize, h_i16u_v2, SZ_I16U) && fsize == SZ_I16U, "./v2_i16u.bin");
    fsize = SZ_I16U;
    FILE_CHECK(ReadFile("./v3_i16u.bin", fsize, h_i16u_v3, SZ_I16U) && fsize == SZ_I16U, "./v3_i16u.bin");

    fsize = SZ_I16U;
    FILE_CHECK(ReadFile("./v1_i16u_ov.bin", fsize, h_i16uo_v1, SZ_I16U) && fsize == SZ_I16U, "./v1_i16u_ov.bin");
    fsize = SZ_I16U;
    FILE_CHECK(ReadFile("./v2_i16u_ov.bin", fsize, h_i16uo_v2, SZ_I16U) && fsize == SZ_I16U, "./v2_i16u_ov.bin");
    fsize = SZ_I16U;
    FILE_CHECK(ReadFile("./v3_i16u_ov.bin", fsize, h_i16uo_v3, SZ_I16U) && fsize == SZ_I16U, "./v3_i16u_ov.bin");

    fsize = SZ_TAIL;
    FILE_CHECK(ReadFile("./v1_tail.bin", fsize, h_tail_v1, SZ_TAIL) && fsize == SZ_TAIL, "./v1_tail.bin");
    fsize = SZ_TAIL;
    FILE_CHECK(ReadFile("./v2_tail.bin", fsize, h_tail_v2, SZ_TAIL) && fsize == SZ_TAIL, "./v2_tail.bin");
    fsize = SZ_TAIL;
    FILE_CHECK(ReadFile("./v3_tail.bin", fsize, h_tail_v3, SZ_TAIL) && fsize == SZ_TAIL, "./v3_tail.bin");
    ...
    LaunchVaddDeepMerged(
        d_f32_v1, d_f32_v2, d_f32_v3, d_f16_v1, d_f16_v2, d_f16_v3, d_bf16_v1, d_bf16_v2, d_bf16_v3, d_x_v1, d_x_v2,
        d_x_v3, d_i16s_v1, d_i16s_v2, d_i16s_v3, d_i16so_v1, d_i16so_v2, d_i16so_v3, d_i16u_v1, d_i16u_v2, d_i16u_v3,
        d_i16uo_v1, d_i16uo_v2, d_i16uo_v3, d_tail_v1, d_tail_v2, d_tail_v3, stream);
...
cleanup:
    ...
    aclrtFree(d_i16s_v2);
    aclrtFree(d_i16s_v3);
    aclrtFree(d_i16so_v1);
    aclrtFree(d_i16so_v2);
    aclrtFree(d_i16so_v3);
    aclrtFree(d_i16u_v1);
    aclrtFree(d_i16u_v2);
    aclrtFree(d_i16u_v3);
    aclrtFree(d_i16uo_v1);
    aclrtFree(d_i16uo_v2);
    aclrtFree(d_i16uo_v3);
    aclrtFree(d_tail_v1);
    aclrtFree(d_tail_v2);
    aclrtFree(d_tail_v3);
    ...
    aclrtFreeHost(h_x_v1);
    aclrtFreeHost(h_x_v2);
    aclrtFreeHost(h_x_v3);
    aclrtFreeHost(h_i16s_v1);
    aclrtFreeHost(h_i16s_v2);
    aclrtFreeHost(h_i16s_v3);
    aclrtFreeHost(h_i16so_v1);
    aclrtFreeHost(h_i16so_v2);
    aclrtFreeHost(h_i16so_v3);
    aclrtFreeHost(h_i16u_v1);
    aclrtFreeHost(h_i16u_v2);
    aclrtFreeHost(h_i16u_v3);
    aclrtFreeHost(h_i16uo_v1);
    aclrtFreeHost(h_i16uo_v2);
    aclrtFreeHost(h_i16uo_v3);
