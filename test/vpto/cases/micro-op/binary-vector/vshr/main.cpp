...
void LaunchVshrDeepMerged(
    uint16_t* p0, uint16_t* p1, uint16_t* p2, int16_t* p3, int16_t* p4, int16_t* p5, uint16_t* p6, uint16_t* p7,
...
int main()
{
    ...
    LaunchVshrDeepMerged(
        d_f32_v1, d_f32_v2, d_f32_v3, d_i16_signed_v1, d_i16_signed_v2, d_i16_signed_v3, d_shift_boundary_v1,
