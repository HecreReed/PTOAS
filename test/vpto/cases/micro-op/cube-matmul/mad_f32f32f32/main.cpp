...
int main()
{
    ...
    inputSize = cSize;
    FILE_CHECK(ReadFile("./v3.bin", inputSize, cSatHost, cSize) && inputSize == cSize, "./v3.bin");
    inputSize = cSize;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, cNoSatHost, cSize) && inputSize == cSize, "./v4.bin");
