...
void LaunchMad_mx_kernel(uint8_t* a, uint8_t* b, uint8_t* a_scale, uint8_t* b_scale, float* c, void* stream);
...
int main()
{
    ...
    LaunchMad_mx_kernel(aDevice, bDevice, aScaleDevice, bScaleDevice, cDevice, stream);
