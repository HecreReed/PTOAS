...
int main()
{
    ...
    inputSize = cSize;
    FILE_CHECK(ReadFile("./v3.bin", inputSize, cTf32Host, cSize) && inputSize == cSize, "./v3.bin");
    inputSize = cSize;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, cPlainHost, cSize) && inputSize == cSize, "./v4.bin");
