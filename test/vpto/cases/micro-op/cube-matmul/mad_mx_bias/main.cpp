...
int main()
{
    ...
    inputSize = biasSize;
    FILE_CHECK(ReadFile("./v6.bin", inputSize, biasHost, biasSize) && inputSize == biasSize, "./v6.bin");
    inputSize = cSize;
    ...
    LaunchMad_mx_bias_kernel(aDevice, bDevice, aScaleDevice, bScaleDevice, biasDevice, cDevice, stream);
