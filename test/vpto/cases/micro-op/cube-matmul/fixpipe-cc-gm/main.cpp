...
void LaunchFixpipe_cc_gm_kernel(__fp16* src, __fp16* id, float* out, float* outCbuf, void* stream);
...
int main()
{
    ...
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v3.bin", inputSize, outHost, kOutSize) && inputSize == kOutSize, "./v3.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, outCbufHost, kOutSize) && inputSize == kOutSize, "./v4.bin");
