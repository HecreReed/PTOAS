...
// scenarios: core-f32, core-f16-u16-offsets, core-u8-u16-offsets, full-mask, non-contiguous, explicit-index-pattern,
// load-effect-validation, no-alias NOTE: bulk-generated coverage skeleton. Parser/verifier/lowering failure is still a
// valid test conclusion in the current coverage-first phase.
// -----------------------------------------------------------------------------
/**
...
int main()
{
    ...
    LaunchVgather2DeepMerged(
        v1Device, v2Device, v3Device, v4Device, v5Device, v6Device, v7Device, v8Device, v9Device, v10Device, stream);
