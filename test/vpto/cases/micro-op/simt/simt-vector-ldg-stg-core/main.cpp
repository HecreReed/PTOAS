...
struct Buffer {
    ...
    void setup(const char* n, size_t s)
    {
        name = n;
        size = s;
    }
...
int main()
{
    ...
    Buffer* allBufs[] = {&bufF32x2,  &bufF16x2, &bufBf16x2,  &bufI16x2,  &bufI32x2,
    ...
    LaunchSimt_vector_ldg_stg_core_kernel(
        bufF32x2.device, bufF16x2.device, bufBf16x2.device, bufI16x2.device, bufI32x2.device, bufHif8x2.device,
        bufI8x2.device, bufFp8e4x2.device, bufFp8e5x2.device, stream);
