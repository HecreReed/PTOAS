...
void LaunchFixpipe_clip_ub_cv_kernel(
    __fp16* src, __fp16* id, __fp16* outUbClip, __fp16* outGmClip, __fp16* outL1Clip, void* stream);
...
int main()
{
    ...
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v3.bin", inputSize, outUbClipHost, kOutSize) && inputSize == kOutSize, "./v3.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, outGmClipHost, kOutSize) && inputSize == kOutSize, "./v4.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v5.bin", inputSize, outL1ClipHost, kOutSize) && inputSize == kOutSize, "./v5.bin");
    ...
    LaunchFixpipe_clip_ub_cv_kernel(srcDevice, idDevice, outUbClipDevice, outGmClipDevice, outL1ClipDevice, stream);
    ...
    FILE_CHECK(WriteFile("./v3.bin", outUbClipHost, kOutSize), "./v3.bin");
    FILE_CHECK(WriteFile("./v4.bin", outGmClipHost, kOutSize), "./v4.bin");
    FILE_CHECK(WriteFile("./v5.bin", outL1ClipHost, kOutSize), "./v5.bin");
