...
int main()
{
    ...
    inputSize = kIdSize;
    FILE_CHECK(ReadFile("./v1.bin", inputSize, idHost, kIdSize) && inputSize == kIdSize, "./v1.bin");
    inputSize = kSrcSize;
    FILE_CHECK(ReadFile("./v2.bin", inputSize, srcHost, kSrcSize) && inputSize == kSrcSize, "./v2.bin");
    inputSize = kFpSize;
    FILE_CHECK(ReadFile("./v3.bin", inputSize, fpHost, kFpSize) && inputSize == kFpSize, "./v3.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, outUbSatHost, kOutSize) && inputSize == kOutSize, "./v4.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v5.bin", inputSize, outUbNosatHost, kOutSize) && inputSize == kOutSize, "./v5.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v6.bin", inputSize, outGmSatHost, kOutSize) && inputSize == kOutSize, "./v6.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v7.bin", inputSize, outGmNosatHost, kOutSize) && inputSize == kOutSize, "./v7.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v8.bin", inputSize, outL1SatHost, kOutSize) && inputSize == kOutSize, "./v8.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v9.bin", inputSize, outL1NosatHost, kOutSize) && inputSize == kOutSize, "./v9.bin");
    ...
    ACL_CHECK(aclrtMemcpy(outUbSatDevice, kOutSize, outUbSatHost, kOutSize, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outUbNosatDevice, kOutSize, outUbNosatHost, kOutSize, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outGmSatDevice, kOutSize, outGmSatHost, kOutSize, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outGmNosatDevice, kOutSize, outGmNosatHost, kOutSize, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outL1SatDevice, kOutSize, outL1SatHost, kOutSize, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outL1NosatDevice, kOutSize, outL1NosatHost, kOutSize, ACL_MEMCPY_HOST_TO_DEVICE));

    LaunchFixpipe_acc_store_sat_f16_cv_kernel(
        srcDevice, idDevice, fpDevice, outUbSatDevice, outUbNosatDevice, outGmSatDevice, outGmNosatDevice,
        outL1SatDevice, outL1NosatDevice, stream);
    ACL_CHECK(aclrtSynchronizeStream(stream));

    ACL_CHECK(aclrtMemcpy(outUbSatHost, kOutSize, outUbSatDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outUbNosatHost, kOutSize, outUbNosatDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outGmSatHost, kOutSize, outGmSatDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outGmNosatHost, kOutSize, outGmNosatDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outL1SatHost, kOutSize, outL1SatDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outL1NosatHost, kOutSize, outL1NosatDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
