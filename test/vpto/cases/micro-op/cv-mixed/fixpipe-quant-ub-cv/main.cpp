...
void LaunchFixpipe_quant_ub_cv_kernel(
    __fp16* src, __fp16* id, uint32_t* fp, __fp16* outUb, __fp16* outGm, __fp16* outL1, void* stream);
...
int main()
{
    ...
    inputSize = kSizeOut;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, outUbHost, kSizeOut) && inputSize == kSizeOut, "./v4.bin");
    inputSize = kSizeOut;
    FILE_CHECK(ReadFile("./v5.bin", inputSize, outGmHost, kSizeOut) && inputSize == kSizeOut, "./v5.bin");
    inputSize = kSizeOut;
    FILE_CHECK(ReadFile("./v6.bin", inputSize, outL1Host, kSizeOut) && inputSize == kSizeOut, "./v6.bin");
    ...
    ACL_CHECK(aclrtMemcpy(outUbDevice, kSizeOut, outUbHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outGmDevice, kSizeOut, outGmHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outL1Device, kSizeOut, outL1Host, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));

    LaunchFixpipe_quant_ub_cv_kernel(srcDevice, idDevice, fpDevice, outUbDevice, outGmDevice, outL1Device, stream);
    ACL_CHECK(aclrtSynchronizeStream(stream));

    ACL_CHECK(aclrtMemcpy(outUbHost, kSizeOut, outUbDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outGmHost, kSizeOut, outGmDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outL1Host, kSizeOut, outL1Device, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
