...
{
    fixpipe_quant_relu_float_payload_f16_ub_cv_kernel<<<1, nullptr, stream>>>(
        (__gm__ __fp16*)lhs, (__gm__ __fp16*)rhs, (__gm__ __fp16*)outUb, (__gm__ __fp16*)outGm, (__gm__ __fp16*)outL1);
}
