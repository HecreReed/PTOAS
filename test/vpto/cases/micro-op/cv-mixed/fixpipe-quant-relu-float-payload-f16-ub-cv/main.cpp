...
void LaunchFixpipe_quant_relu_float_payload_f16_ub_cv_kernel(
    __fp16* lhs, __fp16* rhs, __fp16* outUb, __fp16* outGm, __fp16* outL1, void* stream);
...
int main()
{
    ...
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v3.bin", inputSize, outUbHost, kOutSize) && inputSize == kOutSize, "./v3.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v4.bin", inputSize, outGmHost, kOutSize) && inputSize == kOutSize, "./v4.bin");
    inputSize = kOutSize;
    FILE_CHECK(ReadFile("./v5.bin", inputSize, outL1Host, kOutSize) && inputSize == kOutSize, "./v5.bin");
    ...
    ACL_CHECK(aclrtMemcpy(outUbHost, kOutSize, outUbDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outGmHost, kOutSize, outGmDevice, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outL1Host, kOutSize, outL1Device, kOutSize, ACL_MEMCPY_DEVICE_TO_HOST));
