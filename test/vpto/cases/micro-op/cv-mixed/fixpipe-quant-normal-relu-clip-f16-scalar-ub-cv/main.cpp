...
int main()
{
    ...
    inputSize = kSizeLhs;
    FILE_CHECK(ReadFile("./v1.bin", inputSize, lhsHost, kSizeLhs) && inputSize == kSizeLhs, "./v1.bin");
    inputSize = kSizeRhs;
    FILE_CHECK(ReadFile("./v2.bin", inputSize, rhsHost, kSizeRhs) && inputSize == kSizeRhs, "./v2.bin");
    ...
    ACL_CHECK(aclrtMemcpy(outUbReluDevice, kSizeOut, outUbReluHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outUbClipDevice, kSizeOut, outUbClipHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outGmReluDevice, kSizeOut, outGmReluHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outGmClipDevice, kSizeOut, outGmClipHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outL1ReluDevice, kSizeOut, outL1ReluHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));
    ACL_CHECK(aclrtMemcpy(outL1ClipDevice, kSizeOut, outL1ClipHost, kSizeOut, ACL_MEMCPY_HOST_TO_DEVICE));

    LaunchFixpipe_quant_normal_relu_clip_f16_scalar_ub_cv_kernel(
        lhsDevice, rhsDevice, outUbReluDevice, outUbClipDevice, outGmReluDevice, outGmClipDevice, outL1ReluDevice,
        outL1ClipDevice, stream);
    ACL_CHECK(aclrtSynchronizeStream(stream));

    ACL_CHECK(aclrtMemcpy(outUbReluHost, kSizeOut, outUbReluDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outUbClipHost, kSizeOut, outUbClipDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outGmReluHost, kSizeOut, outGmReluDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outGmClipHost, kSizeOut, outGmClipDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
    ACL_CHECK(aclrtMemcpy(outL1ReluHost, kSizeOut, outL1ReluDevice, kSizeOut, ACL_MEMCPY_DEVICE_TO_HOST));
