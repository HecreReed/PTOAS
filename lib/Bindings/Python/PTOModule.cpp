...
static int32_t enumValueFromPy(py::object value, const char* attrName, const char* enumName)
{
    if (py::isinstance<py::int_>(value))
        return value.cast<int32_t>();
    if (py::hasattr(value, "value"))
        return value.attr("value").cast<int32_t>();
    throw std::runtime_error(std::string(attrName) + ".get expects int or " + enumName + " enum");
}

static void bindPTOEnumAttr(
    pybind11::module& m, const char* attrName, const char* enumName, bool (*isA)(MlirAttribute),
    MlirAttribute (*get)(MlirContext, int32_t), int32_t (*getValue)(MlirAttribute))
{
    mlir_attribute_subclass(m, attrName, isA)
        .def_classmethod(
            "get",
            [attrName, enumName, get](py::object cls, py::object value, MlirContext ctx) -> py::object {
        ...
        .def_property_readonly("value", [getValue](MlirAttribute self) { return getValue(self); });
}
...
static py::object wrapAttributeAs(const py::module_& m, const char* className, MlirAttribute attr)
{
...
void populatePTODialectSubmodule(pybind11::module& m) { (void)m; }
...
void mlir::pto::python::populatePTODialectBindings(pybind11::module_& m)
{
    ...
    mlir_attribute_subclass(
        m, "TInsertModeAttr", [](MlirAttribute a) -> bool { return mlirPTOAttrIsATInsertModeAttr(a); })
        .def_classmethod(
            "get",
    ...
    mlir_attribute_subclass(m, "FenceScopeAttr", [](MlirAttribute a) { return mlirPTOAttrIsAFenceScopeAttr(a); })
        .def_classmethod(
            "get",
            [](py::object cls, py::object value, MlirContext context) -> py::object {
                int32_t v = 0;
            ...
            py::arg("cls"), py::arg("value"), py::arg("context") = py::none())
        .def_property_readonly(
            "value", [](MlirAttribute self) -> int32_t { return mlirPTOFenceScopeAttrGetValue(self); });
    ...
    bindPTOEnumAttr(
        m, "DivPrecisionAttr", "DivPrecision", mlirPTOAttrIsADivPrecisionAttr, mlirPTODivPrecisionAttrGet,
        mlirPTODivPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "ExpPrecisionAttr", "ExpPrecision", mlirPTOAttrIsAExpPrecisionAttr, mlirPTOExpPrecisionAttrGet,
        mlirPTOExpPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "LogPrecisionAttr", "LogPrecision", mlirPTOAttrIsALogPrecisionAttr, mlirPTOLogPrecisionAttrGet,
        mlirPTOLogPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "RecipPrecisionAttr", "RecipPrecision", mlirPTOAttrIsARecipPrecisionAttr, mlirPTORecipPrecisionAttrGet,
        mlirPTORecipPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "RemPrecisionAttr", "RemPrecision", mlirPTOAttrIsARemPrecisionAttr, mlirPTORemPrecisionAttrGet,
        mlirPTORemPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "RsqrtPrecisionAttr", "RsqrtPrecision", mlirPTOAttrIsARsqrtPrecisionAttr, mlirPTORsqrtPrecisionAttrGet,
        mlirPTORsqrtPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "SqrtPrecisionAttr", "SqrtPrecision", mlirPTOAttrIsASqrtPrecisionAttr, mlirPTOSqrtPrecisionAttrGet,
        mlirPTOSqrtPrecisionAttrGetValue);
    bindPTOEnumAttr(
        m, "FmodPrecisionAttr", "FmodPrecision", mlirPTOAttrIsAFmodPrecisionAttr, mlirPTOFmodPrecisionAttrGet,
    ...
    mlir_attribute_subclass(m, "CoalesceAttr", [](MlirAttribute a) { return mlirPTOAttrIsACoalesceAttr(a); })
        .def_classmethod(
            "get",
            [](py::object cls, py::object value, MlirContext ctx) -> py::object {
                int32_t v = 0;
                ...
                MlirAttribute a = mlirPTOCoalesceAttrGet(ctx, static_cast<MlirPTOCoalesce>(v));
                if (mlirAttributeIsNull(a))
                    return py::none();
                return cls.attr("__call__")(a);
            },
            py::arg("cls"), py::arg("value"), py::arg("context") = py::none())
        .def_property_readonly(
            "value", [](MlirAttribute self) -> int32_t { return mlirPTOCoalesceAttrGetValue(self); });
    ...
    mlir_attribute_subclass(m, "QuantScaleAlgAttr", [](MlirAttribute a) { return mlirPTOAttrIsAQuantScaleAlgAttr(a); })
        .def_classmethod(
            "get",
            [](py::object cls, py::object value, MlirContext ctx) -> py::object {
                int32_t v = 0;
            ...
            py::arg("cls"), py::arg("value"), py::arg("context") = py::none())
        .def_property_readonly(
            "value", [](MlirAttribute self) -> int32_t { return mlirPTOQuantScaleAlgAttrGetValue(self); });

    mlir_attribute_subclass(m, "VecStoreModeAttr", [](MlirAttribute a) { return mlirPTOAttrIsAVecStoreModeAttr(a); })
        .def_classmethod(
            "get",
            [](py::object cls, py::object value, MlirContext ctx) -> py::object {
                int32_t v = 0;
            ...
            py::arg("cls"), py::arg("value"), py::arg("context") = py::none())
        .def_property_readonly(
            "value", [](MlirAttribute self) -> int32_t { return mlirPTOVecStoreModeAttrGetValue(self); });
    ...
    mlir_type_subclass(m, "PtrType", [](MlirType type) -> bool { return mlirPTOTypeIsAPtrType(type); })
        .def_classmethod(
            "get",
            [](py::object cls, MlirType elementType, py::object memorySpace, MlirContext context) -> py::object {
                ...
                if (memorySpace.is_none()) {
                    ...
                    MlirAttribute memorySpaceAttr = py::cast<MlirAttribute>(memorySpace);
                    t = mlirPTOPtrTypeGetWithMemorySpace(ctx, elementType, memorySpaceAttr);
                }
                return cls.attr("__call__")(t);
            },
            py::arg("cls"), py::arg("element_type"), py::arg("memory_space") = py::none(),
            py::arg("context") = py::none())
        .def_property_readonly(
            "element_type", [](MlirType self) -> MlirType { return mlirPTOPtrTypeGetElementType(self); })
        .def_property_readonly(
            "memory_space", [](MlirType self) -> MlirAttribute { return mlirPTOPtrTypeGetMemorySpace(self); });

    mlir_type_subclass(m, "VRegType", [](MlirType type) -> bool { return isa<mlir::pto::VRegType>(unwrap(type)); })
        .def_classmethod(
            "get",
            [](py::object cls, int64_t elementCount, MlirType elementType, MlirContext context) -> py::object {
                context = inferContextFromElementType(context, elementType);
                MlirType t = wrap(mlir::pto::VRegType::get(unwrap(context), elementCount, unwrap(elementType)));
                return cls.attr("__call__")(t);
            },
            py::arg("cls"), py::arg("element_count"), py::arg("element_type"), py::arg("context") = py::none())
        .def_property_readonly(
            "element_count",
            [](MlirType self) -> int64_t { return cast<mlir::pto::VRegType>(unwrap(self)).getElementCount(); })
        .def_property_readonly("element_type", [](MlirType self) -> MlirType {
            return wrap(cast<mlir::pto::VRegType>(unwrap(self)).getElementType());
        });

    mlir_type_subclass(m, "MaskType", [](MlirType type) -> bool { return isa<mlir::pto::MaskType>(unwrap(type)); })
        .def_classmethod(
            "get",
            [](py::object cls, std::string granularity, MlirContext context) -> py::object {
                MlirType t = wrap(mlir::pto::MaskType::get(unwrap(context), granularity));
                return cls.attr("__call__")(t);
            },
            py::arg("cls"), py::arg("granularity"), py::arg("context") = py::none())
        .def_property_readonly("granularity", [](MlirType self) -> std::string {
            return cast<mlir::pto::MaskType>(unwrap(self)).getGranularity().str();
        });

    mlir_type_subclass(
        m, "VMIVRegType", [](MlirType type) -> bool { return isa<mlir::pto::VMIVRegType>(unwrap(type)); })
        .def_classmethod(
            "get",
            [](py::object cls, int64_t elementCount, MlirType elementType, py::object layout,
               MlirContext context) -> py::object {
                ...
                MlirType t = wrap(mlir::pto::VMIVRegType::get(
                    unwrap(context), elementCount, unwrap(elementType), unwrap(layoutAttr)));
                return cls.attr("__call__")(t);
            },
            py::arg("cls"), py::arg("element_count"), py::arg("element_type"), py::arg("layout") = py::none(),
            py::arg("context") = py::none())
        .def_property_readonly(
            "element_count",
            [](MlirType self) -> int64_t { return cast<mlir::pto::VMIVRegType>(unwrap(self)).getElementCount(); })
        .def_property_readonly(
            "element_type",
            [](MlirType self) -> MlirType { return wrap(cast<mlir::pto::VMIVRegType>(unwrap(self)).getElementType()); })
        .def_property_readonly("layout", [](MlirType self) -> py::object {
            mlir::Attribute attr = cast<mlir::pto::VMIVRegType>(unwrap(self)).getLayout();
            if (!attr)
                return py::none();
    ...
    mlir_type_subclass(
        m, "VMIMaskType", [](MlirType type) -> bool { return isa<mlir::pto::VMIMaskType>(unwrap(type)); })
        .def_classmethod(
            "get",
            [](py::object cls, int64_t elementCount, std::string granularity, py::object layout,
               MlirContext context) -> py::object {
                MlirAttribute layoutAttr = optionalAttributeFromPy(layout);
                MlirType t =
                    wrap(mlir::pto::VMIMaskType::get(unwrap(context), elementCount, granularity, unwrap(layoutAttr)));
                return cls.attr("__call__")(t);
            },
            py::arg("cls"), py::arg("element_count"), py::arg("granularity") = "pred", py::arg("layout") = py::none(),
            py::arg("context") = py::none())
        .def_property_readonly(
            "element_count",
            [](MlirType self) -> int64_t { return cast<mlir::pto::VMIMaskType>(unwrap(self)).getElementCount(); })
        .def_property_readonly(
            "granularity",
        ...
        .def_property_readonly("layout", [](MlirType self) -> py::object {
            mlir::Attribute attr = cast<mlir::pto::VMIMaskType>(unwrap(self)).getLayout();
            if (!attr)
                return py::none();
            return py::cast(wrap(attr));
        });

    mlir_type_subclass(m, "AlignType", [](MlirType type) -> bool { return isa<mlir::pto::AlignType>(unwrap(type)); })
        .def_classmethod(
            "get",
    ...
    mlir_type_subclass(m, "StructType", [](MlirType type) -> bool { return isa<mlir::pto::StructType>(unwrap(type)); })
        .def_classmethod(
            "get",
            [](py::object cls, py::sequence fieldTypes, MlirContext context) -> py::object {
                ...
                auto structType = mlir::pto::StructType::getChecked(
                    [&]() { return mlir::emitError(mlir::UnknownLoc::get(unwrap(context))); }, unwrap(context),
                    llvm::ArrayRef<mlir::Type>(unwrappedFields));
                if (!structType)
                    throw py::value_error("StructType.get received invalid struct field types");
                return cls.attr("__call__")(wrap(structType));
            },
            py::arg("cls"), py::arg("field_types"), py::arg("context") = py::none())
        .def_property_readonly("field_types", [](MlirType self) -> py::list {
    ...
    mlir_type_subclass(m, "F8E8M0Type", [](MlirType type) -> bool { return mlirPTOTypeIsAF8E8M0Type(type); })
        .def_classmethod(
            "get",
            [](py::object cls, MlirContext context) -> py::object {
    ...
    mlir_type_subclass(m, "HiF8x2Type", [](MlirType type) -> bool { return mlirPTOTypeIsAHiF8x2Type(type); })
        .def_classmethod(
            "get",
            [](py::object cls, MlirContext context) -> py::object {
    ...
    mlir_type_subclass(m, "TensorViewType", [](MlirType type) -> bool { return mlirPTOTypeIsATensorViewType(type); })
        .def_classmethod(
            ...
            [](py::object cls, py::object shape_or_rank, MlirType elementType, MlirContext context) -> py::object {
                ...
                context = inferContextFromElementType(context, elementType);
                MlirType t = mlirPTOTensorViewTypeGet(context, (intptr_t)shp.size(), shp.data(), elementType);
                return cls.attr("__call__")(t);
            },
    ...
    mlir_type_subclass(
        ...
        .def_classmethod(
            ...
            [](py::object cls, py::object shape_or_rank, MlirType elementType, MlirContext context) -> py::object {
                std::vector<int64_t> shp = toShapeVectorOrDynamicRank(shape_or_rank);
                context = inferContextFromElementType(context, elementType);
                MlirType t = mlirPTOPartitionTensorViewTypeGet(context, (intptr_t)shp.size(), shp.data(), elementType);
                return cls.attr("__call__")(t);
            },
            py::arg("cls"), py::arg("shape_or_rank"), py::arg("element_type"), py::arg("context") = py::none())
        .def_property_readonly(
    ...
    mlir_type_subclass(m, "TileType", [](MlirType t) -> bool { return mlirPTOTypeIsATileType(t); })
        .def_classmethod(
            ...
            [](py::object cls, py::sequence shape, MlirType elementType, MlirContext context) -> py::object {
                ...
                MlirType t = mlirPTOTileTypeGet(context, (intptr_t)shp.size(), shp.data(), elementType);
                return cls.attr("__call__")(t);
            },
               ...
               py::object validShapeObj, py::object configObj, MlirContext ctx) -> py::object {
                ...
                if (!configObj.is_none()) {
                    ...
                    ty = mlirPTOTileBufTypeGetWithValidShapeAndConfig(
                        ctx, (intptr_t)shape.size(), shape.data(), elementType, memorySpace,
                        (intptr_t)validShape.size(), validShape.data(), cfg);
                } else {
