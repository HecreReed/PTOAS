...
@tilelib.tile_template(
    op="pto.tmatmul.mx",
    target="a5",
    name="template_tmatmul_mx",
    dtypes=MATMUL_MX_DTYPES,
    iteration_axis="none",
    op_engine="cube",
    op_class="other",
    id=0,
...
def template_tmatmul_mx(
    ...
    _, n = rhs.valid_shape
    pto.mad_mx(
        lhs.as_ptr(), rhs.as_ptr(), dst.as_ptr(), m, n, k, disable_gemv=True, sat="sat"
    )
...
@tilelib.tile_template(
    ...
    target="a5",
    name="template_tmatmul_mx_acc",
    dtypes=MATMUL_MX_ACC_DTYPES,
    iteration_axis="none",
    op_engine="cube",
    op_class="other",
    id=0,
...
@tilelib.tile_template(
    ...
    target="a5",
    name="template_tmatmul_mx_bias",
    dtypes=MATMUL_MX_BIAS_DTYPES,
    iteration_axis="none",
    op_engine="cube",
    op_class="other",
    id=0,
