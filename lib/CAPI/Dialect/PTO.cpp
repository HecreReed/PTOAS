...
MlirType mlirPTOPtrTypeGetWithMemorySpace(MlirContext ctx, MlirType elementType, MlirAttribute memorySpace)
{
    auto c = unwrap(ctx);
    auto elem = unwrap(elementType);
...
bool mlirPTOTypeIsAF8E8M0Type(MlirType type) { return isa<mlir::pto::F8E8M0Type>(unwrap(type)); }

MlirType mlirPTOF8E8M0TypeGet(MlirContext ctx) { return wrap(mlir::pto::F8E8M0Type::get(unwrap(ctx))); }

bool mlirPTOTypeIsAHiF8x2Type(MlirType type) { return isa<mlir::pto::HiF8x2Type>(unwrap(type)); }

MlirType mlirPTOHiF8x2TypeGet(MlirContext ctx) { return wrap(mlir::pto::HiF8x2Type::get(unwrap(ctx))); }
...
#define DEFINE_PTO_ENUM_ATTR_CAPI(NAME, ATTR, ENUM)                                                          \
    ...
    {                                                                                                        \
        ...
        return wrap(mlir::pto::ATTR::get(c, mode));                                                          \
                                                                                                             ...
                                                                                                             \
    bool mlirPTOAttrIsA##NAME##Attr(MlirAttribute attr) { return mlir::isa<mlir::pto::ATTR>(unwrap(attr)); } \
                                                                                                             \
...
bool mlirPTOAttrIsAFenceScopeAttr(MlirAttribute attr) { return mlir::isa<mlir::pto::FenceScopeAttr>(unwrap(attr)); }
...
bool mlirPTOAttrIsAVecStoreModeAttr(MlirAttribute attr) { return mlir::isa<mlir::pto::VecStoreModeAttr>(unwrap(attr)); }
...
bool mlirPTOAttrIsACoalesceAttr(MlirAttribute attr) { return mlir::isa<mlir::pto::CoalesceAttr>(unwrap(attr)); }
...
bool mlirPTOAttrIsATInsertModeAttr(MlirAttribute attr) { return mlir::isa<mlir::pto::TInsertModeAttr>(unwrap(attr)); }

MlirAttribute mlirPTOTInsertModeAttrGet(MlirContext ctx, int32_t value)
{
    auto* c = unwrap(ctx);
    return wrap(mlir::pto::TInsertModeAttr::get(c, static_cast<mlir::pto::TInsertMode>(value)));
}
