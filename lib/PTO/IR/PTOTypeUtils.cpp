...
bool mlir::pto::isPTOFloat8Type(Type t) { return isPTOFloat8E4M3LikeType(t) || isPTOFloat8E5M2LikeType(t); }

bool mlir::pto::isPTOFloat8E4M3LikeType(Type t)
{
    return isa<Float8E4M3Type, Float8E4M3FNType, Float8E4M3FNUZType, Float8E4M3B11FNUZType>(t);
}

bool mlir::pto::isPTOFloat8E5M2LikeType(Type t) { return isa<Float8E5M2Type, Float8E5M2FNUZType>(t); }
...
bool mlir::pto::isPTOPackedLdgStgVectorType(Type t)
{
    ...
    if (isPTOFloat8Type(elemType)) {
        ...
        validElem = lanes == 2 && (elemType.isF16() || elemType.isBF16() || elemType.isF32());
    }
    if (!validElem) {
    ...
    if (!validElem)
        return false;
    unsigned totalBits = vecType.getDimSize(0) * getPTOStorageElemBitWidth(elemType);
...
unsigned mlir::pto::getPTOPackedLdgStgTotalBits(Type t)
{
    ...
    return vecType.getDimSize(0) * getPTOStorageElemBitWidth(vecType.getElementType());
}

bool mlir::pto::isPTOLowPrecisionType(Type t)
{
    return isPTOFloat8Type(t) || isPTOHiFloat8Type(t) || isPTOF8E8M0Type(t) || isPTOHiFloat8x2Type(t) ||
           isPTOFloat4PackedType(t);
}
