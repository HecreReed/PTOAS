...
template <typename Derived, typename OpTy, bool supportMixedTensorBufferMode = true>
struct PTODpsOpInterfaceBase : public DstBufferizableOpInterfaceExternalModel<Derived, OpTy> {
...
struct PTOReadWriteDpsOpInterfaceBase : public PTODpsOpInterfaceBase<Derived, OpTy> {
...
struct PTOAddOpInterface : public PTOReadWriteDpsOpInterfaceBase<PTOAddOpInterface, pto::TAddOp> {
    bool bufferizesToElementwiseAccess(Operation* op, const AnalysisState& state, ArrayRef<OpOperand*> opOperands) const
    {
        return true;
    }
};

struct PTOMatmulOpInterface : public PTOReadWriteDpsOpInterfaceBase<PTOMatmulOpInterface, pto::TMatmulOp> {};
