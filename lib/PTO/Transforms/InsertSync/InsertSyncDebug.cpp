    ...
    bool showMemInfo)
{
    ...
    int indent = 0;
    auto indentBy = [&](int extra = 0) { return static_cast<unsigned>(std::max(0, indent) * 2 + extra); };
    ...
    llvm::raw_ostream& os)
{
    ...
    os << llvm::formatv(
        ...
        syncIR.size(), syncOperations.size(), activeOps, setCnt, waitCnt, barrierCnt, blockSetCnt, blockWaitCnt,
        blockAllCnt);
