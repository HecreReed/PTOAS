...
bool RemoveRedundantSync::CheckAllSync(SyncOperation* setFlag, SyncOperation* waitFlag)
{
...
bool RemoveRedundantSync::CheckRepeatSync(
    unsigned int begin, unsigned int end, SmallVector<bool>& syncFinder, SyncOperation* setFlag)
{
...
bool RemoveRedundantSync::CheckBranchBetween(
    BranchInstanceElement* branchElement, SmallVector<bool> syncFinder, SyncOperation* setFlag, unsigned endId,
    unsigned& i)
{
    // 只处理 IF_BEGIN
...
bool RemoveRedundantSync::CheckLoopBetween(LoopInstanceElement* loopElement, SyncOperation* setFlag, unsigned& i)
{
...
bool RemoveRedundantSync::CanMatchedSync(
    SmallVector<bool>& syncFinder, SyncOperation* relatedSync, SyncOperation* setFlag)
{
