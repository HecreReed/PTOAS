...
- 默认以 `references/ptoas-usability-scorecard-10pt.csv` 的 `30` 个 `Touch-Point` 作为唯一分项基线。
...
3. 读 [references/ptoas-usability-scorecard-10pt.csv](references/ptoas-usability-scorecard-10pt.csv)，以 Excel 同步下来的 `30` 个 `Touch-Point` 定义、量化指标、打分规则与 VOD 备注为准。
