...
private:
    ...
    void SetUseEventID(unsigned int begin, unsigned int end, int scopePair, unsigned int eventId, size_t poolSize);
    ...
    void SeedHiddenMacroEventIds(const llvm::SmallSet<int, kReallocatedPipePairInlineCapacity>* scopeFilter = nullptr);
